...
export declare const Chip: ({ bgColor, className, color, height, icon, iconColor, iconProps, label, padding, width, ...props }: ChipProps) => import("react/jsx-runtime").JSX.Element;
