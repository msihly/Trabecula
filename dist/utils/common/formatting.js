...
const duration = (val, isMs = false) => !isNaN(val) ? common_1.dayjs.duration(val, isMs ? "ms" : "s").format("HH:mm:ss") : null;
const frameToSec = (frame, frameRate) => (0, common_1.round)(frame / frameRate, 3);
