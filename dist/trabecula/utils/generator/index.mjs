...
var createMethodShim = (methodName, getImplementation) => (flags, object, ...arguments_) => {
  ...
  const implementation = (_a10 = getImplementation.call(object)) != null ? _a10 : object[methodName];
...
var assertAlignType = true ? noop_default : function(alignType) {
  if (!(typeof alignType === "number" || typeof alignType === "string" || (alignType == null ? void 0 : alignType.type) === "root")) {
...
function conditionalGroup(states, options8) {
  return group(states[0], __spreadProps(__spreadValues({}, options8), { expandedStates: states }));
}
...
var _a;
var stringReplaceAll = (_a = String.prototype.replaceAll) != null ? _a : function(pattern, replacement) {
  if (pattern.global) {
...
function generateIndent(indent22, command, options8) {
  ...
  flushSpaces();
  return __spreadProps(__spreadValues({}, indent22), { value, length, queue });
...
function makeAlign(indent22, indentOptions, options8) {
  ...
  if (indentOptions.type === "root") {
    return __spreadProps(__spreadValues({}, indent22), { root: indent22 });
  }
  ...
  return generateIndent(indent22, command, options8);
}
  ...
  while (remainingWidth >= 0) {
    ...
    switch (docType) {
      ...
      case DOC_TYPE_FILL: {
        ...
        const end = (_a10 = doc[DOC_FILL_PRINTED_LENGTH]) != null ? _a10 : 0;
...
function printDocToString(doc, options8) {
  ...
  const newLine = convertEndOfLineOptionToCharacter(options8.endOfLine);
  let position = 0;
  const commands = [{
    indent: ROOT_INDENT,
    mode: MODE_BREAK,
  ...
  while (commands.length > 0) {
    ...
    switch (get_doc_type_default(doc2)) {
      ...
      case DOC_TYPE_FILL: {
        const remainingWidth = width - position;
        const offset = (_a10 = doc2[DOC_FILL_PRINTED_LENGTH]) != null ? _a10 : 0;
        const {
          parts
        } = doc2;
        ...
        const remainingCommand = {
          indent: indent22,
          mode,
          doc: __spreadProps(__spreadValues({}, doc2), {
...
var import_meta = {};
var require2 = __prettierCreateRequire(import_meta.url);
var __filename = __prettierFileUrlToPath(import_meta.url);
...
var require_path = __commonJS2({
  "node_modules/fast-glob/out/utils/path.js"(exports) {
    ...
    function makeAbsolute(cwd, filepath) {
      return path152.resolve(cwd, filepath);
    }
...
var require_to_regex_range = __commonJS2({
  "node_modules/to-regex-range/index.js"(exports, module) {
    ...
    var toRegexRange = (min, max, options8) => {
      ...
      let opts = __spreadValues({ relaxZeros: true }, options8);
...
var require_fill_range = __commonJS2({
  "node_modules/fill-range/index.js"(exports, module) {
    ...
    var toRange = (a, b, isNumbers, options8) => {
      if (isNumbers) {
        return toRegexRange(a, b, __spreadValues({ wrap: false }, options8));
      }
    ...
    var fillNumbers = (start, end, step = 1, options8 = {}) => {
      ...
      if (options8.toRegex === true) {
        return step > 1 ? toSequence(parts, options8, maxLen) : toRegex(range, null, __spreadValues({ wrap: false }, options8));
      }
      return range;
    };
    ...
    var fill2 = (start, end, step, options8 = {}) => {
      ...
      let opts = __spreadValues({}, options8);
    ...
    var compile = (ast, options8 = {}) => {
      const walk = (node, parent = {}) => {
        ...
        if (node.nodes && node.ranges > 0) {
          ...
          const range = fill2(...args, __spreadProps(__spreadValues({}, options8), { wrap: false, toRegex: true, strictZeros: true }));
          if (range.length !== 0) {
...
var require_parse2 = __commonJS2({
  "node_modules/micromatch/node_modules/picomatch/lib/parse.js"(exports, module) {
    ...
    var parse7 = (input, options8) => {
      ...
      const opts = __spreadValues({}, options8);
      const max = typeof opts.maxLength === "number" ? Math.min(MAX_LENGTH, opts.maxLength) : MAX_LENGTH;
      ...
      const extglobClose = (token2) => {
        ...
        if (token2.type === "negate") {
          ...
          if (token2.inner.includes("*") && (rest = remaining()) && /^\.[^\\/.]+$/.test(rest)) {
            const expression = parse7(rest, __spreadProps(__spreadValues({}, options8), { fastpaths: false })).output;
...
var require_picomatch = __commonJS2({
  "node_modules/micromatch/node_modules/picomatch/lib/picomatch.js"(exports, module) {
    ...
    var picomatch = (glob, options8, returnState = false) => {
      ...
      if (opts.ignore) {
        const ignoreOpts = __spreadProps(__spreadValues({}, options8), { ignore: null, onMatch: null, onResult: null });
    ...
    picomatch.parse = (pattern, options8) => {
      ...
      return parse7(pattern, __spreadProps(__spreadValues({}, options8), { fastpaths: false }));
    };
  ...
  "node_modules/micromatch/index.js"(exports, module) {
    ...
    var micromatch2 = (list, patterns, options8) => {
      ...
      for (let i = 0; i < patterns.length; i++) {
        let isMatch = picomatch(String(patterns[i]), __spreadProps(__spreadValues({}, options8), { onResult }), true);
    ...
    micromatch2.not = (list, patterns, options8 = {}) => {
      ...
      let matches = new Set(micromatch2(list, patterns, __spreadProps(__spreadValues({}, options8), { onResult })));
    ...
    micromatch2.contains = (str, pattern, options8) => {
      ...
      return micromatch2.isMatch(str, pattern, __spreadProps(__spreadValues({}, options8), { contains: true }));
    };
    ...
    micromatch2.capture = (glob, input, options8) => {
      ...
      let regex = picomatch.makeRe(String(glob), __spreadProps(__spreadValues({}, options8), { capture: true }));
    ...
    micromatch2.braceExpand = (pattern, options8) => {
      if (typeof pattern !== "string") throw new TypeError("Expected a string");
      return micromatch2.braces(pattern, __spreadProps(__spreadValues({}, options8), { expand: true }));
    };
...
var require_pattern = __commonJS2({
  "node_modules/fast-glob/out/utils/pattern.js"(exports) {
    ...
    function isAffectDepthOfReadingPattern(pattern) {
      const basename = path152.basename(pattern);
...
var require_utils3 = __commonJS2({
  "node_modules/fast-glob/out/utils/index.js"(exports) {
    ...
    var fs42 = require_fs();
    exports.fs = fs42;
    var path152 = require_path();
    exports.path = path152;
...
var require_async = __commonJS2({
  "node_modules/@nodelib/fs.stat/out/providers/async.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.read = void 0;
    function read3(path152, settings, callback) {
      settings.fs.lstat(path152, (lstatError, lstat2) => {
        if (lstatError !== null) {
...
var require_sync = __commonJS2({
  "node_modules/@nodelib/fs.stat/out/providers/sync.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.read = void 0;
    function read3(path152, settings) {
      const lstat2 = settings.fs.lstatSync(path152);
      if (!lstat2.isSymbolicLink() || !settings.followSymbolicLink) {
        return lstat2;
      }
      try {
...
var require_settings = __commonJS2({
  "node_modules/@nodelib/fs.stat/out/settings.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var fs42 = require_fs2();
    var Settings = class {
      constructor(_options = {}) {
        this._options = _options;
        this.followSymbolicLink = this._getValue(this._options.followSymbolicLink, true);
        this.fs = fs42.createFileSystemAdapter(this._options.fs);
...
var require_out = __commonJS2({
  "node_modules/@nodelib/fs.stat/out/index.js"(exports) {
    ...
    exports.stat = stat2;
    function statSync2(path152, optionsOrSettings) {
    ...
    function readdir(directory, settings, callback) {
      settings.fs.readdir(directory, (readdirError, names) => {
        ...
        const tasks = names.map((name) => {
          const path152 = common.joinPathSegments(directory, name, settings.pathSegmentSeparator);
          return (done) => {
            fsStat.stat(path152, settings.fsStatSettings, (error, stats) => {
              if (error !== null) {
                done(error);
                return;
              }
...
var require_fs4 = __commonJS2({
  "node_modules/@nodelib/fs.scandir/out/adapters/fs.js"(exports) {
    ...
    exports.FILE_SYSTEM_ADAPTER = {
      ...
      lstatSync: fs42.lstatSync,
      statSync: fs42.statSync,
      readdir: fs42.readdir,
      readdirSync: fs42.readdirSync
    };
    function createFileSystemAdapter(fsMethods) {
      if (fsMethods === void 0) {
        return exports.FILE_SYSTEM_ADAPTER;
...
var require_out2 = __commonJS2({
  "node_modules/@nodelib/fs.scandir/out/index.js"(exports) {
    ...
    exports.Settings = settings_1.default;
    function scandir(path152, optionsOrSettingsOrCallback, callback) {
      if (typeof optionsOrSettingsOrCallback === "function") {
        async.read(path152, getSettings(), optionsOrSettingsOrCallback);
        return;
      }
    ...
    function scandirSync(path152, optionsOrSettings) {
      const settings = getSettings(optionsOrSettings);
      return sync.read(path152, settings);
    }
  ...
  "node_modules/fast-glob/out/readers/reader.js"(exports) {
    ...
    var Reader = class {
      ...
      _getFullEntryPath(filepath) {
        return path152.resolve(this._settings.cwd, filepath);
      }
  ...
  "node_modules/fast-glob/out/providers/provider.js"(exports) {
    ...
    var Provider = class {
      ...
      _getRootDirectory(task) {
        return path152.resolve(this._settings.cwd, task.base);
      }
    ...
    var ProviderAsync = class extends provider_1.default {
      ...
      read(task) {
        return __async(this, null, function* () {
          ...
          const entries = yield this.api(root2, task, options8);
...
var require_out4 = __commonJS2({
  "node_modules/fast-glob/out/index.js"(exports, module) {
    ...
    var utils2 = require_utils3();
    function FastGlob(source2, options8) {
      return __async(this, null, function* () {
...
var require_picocolors2 = __commonJS2({
  "node_modules/picocolors/picocolors.js"(exports, module) {
    var p = process || {};
    var argv = p.argv || [];
    var env = p.env || {};
    ...
    var replaceClose = (string, close, replace, index) => {
      ...
      do {
        result += string.substring(cursor22, index) + replace;
        cursor22 = index + close.length;
        index = string.indexOf(close, cursor22);
      } while (~index);
  ...
  "node_modules/editorconfig/src/lib/fnmatch.js"(exports, module) {
    ...
    Minimatch.prototype.matchOne = function(file, pattern, partial) {
      ...
      if (options8.matchBase && pattern.length === 1) {
        file = path152.basename(file.join("/")).split("/");
      }
      if (options8.debug) {
...
var require_ini = __commonJS2({
  "node_modules/editorconfig/src/lib/ini.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var fs42 = __importStar(__require("fs"));
    var regex = {
      section: /^\s*\[(([^#;]|\\#|\\;)+)\]\s*([#;].*)?$/,
      param: /^\s*([\w\.\-\_]+)\s*[=:]\s*(.*?)\s*([#;].*)?$/,
      comment: /^\s*[#;].*$/
      ...
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a10) {
          return [2, new Promise(function(resolve3, reject) {
            fs42.readFile(file, "utf8", function(err, data) {
              if (err) {
                reject(err);
                return;
              }
    ...
    function parseSync(file) {
      return parseString2(fs42.readFileSync(file, "utf8"));
    }
...
var require_src = __commonJS2({
  "node_modules/editorconfig/src/index.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var fs42 = __importStar(__require("fs"));
    var path152 = __importStar(__require("path"));
    var semver = {
      gte: require_gte()
    };
    ...
    function getConfigFileNames(filepath, options8) {
      var paths = [];
      do {
        filepath = path152.dirname(filepath);
        paths.push(path152.join(filepath, options8.config));
    ...
    function processOptions(options8, filepath) {
      ...
      return {
        ...
        root: path152.resolve(options8.root || path152.parse(filepath).root)
      };
    }
    function buildFullGlob(pathPrefix, glob) {
      ...
      return path152.join(pathPrefix, glob);
    }
    ...
    function parseFromConfigs(configs, filepath, options8) {
      return processMatches(configs.reverse().reduce(function(matches, file) {
        var pathPrefix = path152.dirname(file.name);
        ...
        return __generator(this, function(_a10) {
          return [2, Promise.all(filepaths.map(function(name) {
            return new Promise(function(resolve3) {
              fs42.readFile(name, "utf8", function(err, data) {
                resolve3({
                  name,
                  contents: err ? "" : data
                });
    ...
    function readConfigFilesSync(filepaths) {
      ...
      filepaths.forEach(function(filepath) {
        try {
          file = fs42.readFileSync(filepath, "utf8");
        } catch (e) {
          file = "";
        }
        files.push({
    ...
    function opts(filepath, options8) {
      ...
      var resolvedFilePath = path152.resolve(filepath);
      return [
        resolvedFilePath,
    ...
    function parseFromFiles(filepath, files, options8) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a10, resolvedFilePath, processedOptions;
        return __generator(this, function(_b) {
          _a10 = opts(filepath, options8), resolvedFilePath = _a10[0], processedOptions = _a10[1];
    ...
    function parseFromFilesSync(filepath, files, options8) {
      ...
      var _a10 = opts(filepath, options8), resolvedFilePath = _a10[0], processedOptions = _a10[1];
    ...
    function parse7(_filepath, _options) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a10, resolvedFilePath, processedOptions, filepaths;
        return __generator(this, function(_b) {
          _a10 = opts(_filepath, _options), resolvedFilePath = _a10[0], processedOptions = _a10[1];
    ...
    function parseSync(_filepath, _options) {
      ...
      var _a10 = opts(_filepath, _options), resolvedFilePath = _a10[0], processedOptions = _a10[1];
    ...
    var LineByLine = class {
      ...
      _readChunk(lineLeftovers) {
        ...
        do {
          ...
          bytesRead = fs42.readSync(this.fd, readBuffer, 0, this.options.readChunk, this.fdPosition);
...
var require_ignore = __commonJS2({
  "node_modules/ignore/index.js"(exports, module) {
    ...
    var RuleManager = class {
      ...
      test(path152, checkUnignored, mode) {
        let ignored = false;
        let unignored = false;
        let matchedRule;
        this._rules.forEach((rule) => {
          ...
          const matched = rule[mode].test(path152);
          if (!matched) {
            return;
          }
          ignored = !negative;
    ...
    var checkPath = (path152, originalPath, doThrow) => {
      if (!isString(path152)) {
        return doThrow(
      ...
      if (checkPath.isNotRelative(path152)) {
    ...
    var isNotRelative = (path152) => REGEX_TEST_INVALID_PATH.test(path152);
    ...
    var Ignore = class {
      ...
      _test(originalPath, cache3, checkUnignored, slices) {
        const path152 = originalPath && checkPath.convert(originalPath);
        checkPath(
          path152,
          originalPath,
          this._strictPathCheck ? throwError : RETURN_FALSE
        );
        return this._t(path152, cache3, checkUnignored, slices);
      }
      checkIgnore(path152) {
        if (!REGEX_TEST_TRAILING_SLASH.test(path152)) {
          return this.test(path152);
        }
        const slices = path152.split(SLASH).filter(Boolean);
        slices.pop();
        if (slices.length) {
        ...
        return this._rules.test(path152, false, MODE_CHECK_IGNORE);
      }
      _t(path152, cache3, checkUnignored, slices) {
        if (path152 in cache3) {
          return cache3[path152];
        }
        if (!slices) {
          slices = path152.split(SLASH).filter(Boolean);
        }
        slices.pop();
        if (!slices.length) {
          return cache3[path152] = this._rules.test(path152, checkUnignored, MODE_IGNORE);
        }
        const parent = this._t(
          slices.join(SLASH) + SLASH,
          cache3,
        ...
        return cache3[path152] = parent.ignored ? parent : this._rules.test(path152, checkUnignored, MODE_IGNORE);
      }
      ignores(path152) {
        return this._test(path152, this._ignoreCache, false).ignored;
      }
      createFilter() {
        return (path152) => !this.ignores(path152);
      }
      filter(paths) {
    ...
    var setupWindows = () => {
      ...
      checkPath.isNotRelative = (path152) => REGEX_TEST_WINDOWS_PATH_ABSOLUTE.test(path152) || isNotRelative(path152);
    };
    if (
...
var Diff = class {
  ...
  diffWithOptionsObj(oldTokens, newTokens, options8, callback) {
    ...
    const maxExecutionTime = (_a10 = options8.timeout) !== null && _a10 !== void 0 ? _a10 : Infinity;
  ...
  addToPath(path152, added, removed, oldPosInc, options8) {
    const last = path152.lastComponent;
    if (last && !options8.oneChangePerToken && last.added === added && last.removed === removed) {
      return {
        oldPos: path152.oldPos + oldPosInc,
...
function leven(first, second, options8) {
  ...
  const maxDistance = options8 == null ? void 0 : options8.maxDistance;
  const swap = first;
...
function closestMatch(target, candidates, options8) {
  ...
  const userMax = options8 == null ? void 0 : options8.maxDistance;
...
var import_picocolors5 = __toESM2(require_picocolors2(), 1);
var apiDescriptor = {
...
var commonInvalidHandler = (key2, value, utils2) => {
  const { text, list } = utils2.normalizeExpectedResult(utils2.schemas[key2].expected(utils2));
  const descriptions = [];
  if (text) {
    descriptions.push(getDescription(key2, value, text, utils2.descriptor));
  }
  if (list) {
    descriptions.push([getDescription(key2, value, list.title, utils2.descriptor)].concat(list.values.map((valueDescription) => getListDescription(valueDescription, utils2.loggerPrintWidth))).join("\n"));
  }
...
var import_picocolors3 = __toESM2(require_picocolors2(), 1);
...
var ArraySchema = class extends Schema {
  constructor(_a10) {
    var _b = _a10, { valueSchema, name = valueSchema.name } = _b, handlers = __objRest(_b, ["valueSchema", "name"]);
    super(__spreadProps(__spreadValues({}, handlers), { name }));
...
function createMockable(implementations) {
  const mocked = __spreadValues({}, implementations);
...
var import_editorconfig = __toESM2(require_src(), 1);
var isFile = (stats) => stats == null ? void 0 : stats.isFile();
var isDirectory = (stats) => stats == null ? void 0 : stats.isDirectory();
function findInDirectory(_0, _1) {
  return __async(this, arguments, function* (nameOrNames, { typeCheck, cwd, allowSymlinks = true, filter: filter2 }) {
    var _a10;
    const directory = (_a10 = toAbsolutePath(cwd)) != null ? _a10 : process2.cwd();
    const names = Array.isArray(nameOrNames) ? nameOrNames : [nameOrNames];
    for (const name of names) {
      const fileOrDirectory = path2.join(directory, name);
      const stats = yield safeStat(fileOrDirectory, allowSymlinks);
      if ((yield typeCheck(stats)) && (!filter2 || (yield filter2({ name, path: fileOrDirectory, stats })))) {
        return fileOrDirectory;
      }
    }
  });
}
function safeStat(path152, allowSymlinks = true) {
  return __async(this, null, function* () {
    try {
      return yield (allowSymlinks ? fs.stat : fs.lstat)(path152);
    } catch (e) {
    }
  });
}
function findFile(nameOrNames, options8) {
  return findInDirectory(nameOrNames, __spreadProps(__spreadValues({}, options8), { typeCheck: isFile }));
}
function findDirectory(nameOrNames, options8) {
  return findInDirectory(nameOrNames, __spreadProps(__spreadValues({}, options8), { typeCheck: isDirectory }));
}
function* iterateDirectoryUp(from, to) {
  var _a10;
  let directory = (_a10 = toAbsolutePath(from)) != null ? _a10 : process3.cwd();
...
var _stopDirectory, _cache, _resultCache, _searchWithoutCache, _Searcher_instances, search_fn, _a2;
var Searcher = (_a2 = class {
  /**
  ...
  */
  constructor(nameOrNames, { allowSymlinks, filter: filter2, stopDirectory, cache: cache3 } = {}) {
    ...
    */
    ...
    __privateSet(this, _cache, cache3 != null ? cache3 : true);
  ...
  /**
    ...
    */
  search(startDirectory, options8) {
    return __async(this, null, function* () {
      var _a10;
      for (const directory of iterate_directory_up_default(
        ...
        const result = yield __privateMethod(this, _Searcher_instances, search_fn).call(this, directory, (_a10 = options8 == null ? void 0 : options8.cache) != null ? _a10 : __privateGet(this, _cache));
        if (result) {
          return result;
        }
      }
...
}, _stopDirectory = new WeakMap(), _cache = new WeakMap(), _resultCache = new WeakMap(), _searchWithoutCache = new WeakMap(), _Searcher_instances = new WeakSet(), search_fn = function(directory, cache3 = true) {
...
var FileSearcher = class extends Searcher {
  constructor() {
    super(...arguments);
    /** @protected */
    __publicField(this, "findInDirectory", findFile);
  }
};
var DirectorySearcher = class extends Searcher {
  constructor() {
    super(...arguments);
    /** @protected */
    __publicField(this, "findInDirectory", findDirectory);
  }
};
var DIRECTORIES = [".git", ".hg"];
var searcher;
function findProjectRoot(startDirectory, options8) {
  return __async(this, null, function* () {
    searcher != null ? searcher : searcher = new DirectorySearcher(DIRECTORIES, { allowSymlinks: false });
    const directory = yield searcher.search(startDirectory, {
...
function loadEditorconfigInternal(_0, _1) {
  return __async(this, arguments, function* (file, { shouldCache }) {
    const directory = path5.dirname(file);
    const root2 = yield findProjectRoot(directory, { shouldCache });
    const editorConfig = yield import_editorconfig.default.parse(file, { root: root2 });
...
var _input, _jsonParseError, _message, _codeFrame, _rawCodeFrame, __JSONError_instances, getCodeFrame_fn, _a3;
var JSONError = (_a3 = class extends Error {
  constructor(messageOrOptions) {
    var __super = (...args) => {
      super(...args);
      __privateAdd(this, __JSONError_instances);
    ...
    (_a10 = Error.captureStackTrace) == null ? void 0 : _a10.call(Error, this, _a3);
  }
  get message() {
    var _a10;
    (_a10 = __privateGet(this, _message)) != null ? _a10 : __privateSet(this, _message, `${addCodePointToUnexpectedToken(__privateGet(this, _jsonParseError).message)}${__privateGet(this, _input) === "" ? " while parsing empty string" : ""}`);
...
` : ""}`;
  ...
  get codeFrame() {
    var _a10;
    (_a10 = __privateGet(this, _codeFrame)) != null ? _a10 : __privateSet(this, _codeFrame, __privateMethod(this, __JSONError_instances, getCodeFrame_fn).call(
      this,
      /* highlightCode */
      true
    ));
  ...
  get rawCodeFrame() {
    var _a10;
    (_a10 = __privateGet(this, _rawCodeFrame)) != null ? _a10 : __privateSet(this, _rawCodeFrame, __privateMethod(this, __JSONError_instances, getCodeFrame_fn).call(
      this,
      /* highlightCode */
      false
    ));
...
}, _input = new WeakMap(), _jsonParseError = new WeakMap(), _message = new WeakMap(), _codeFrame = new WeakMap(), _rawCodeFrame = new WeakMap(), __JSONError_instances = new WeakSet(), getCodeFrame_fn = function(highlightCode) {
...
var getErrorLocation = (string, message) => {
  const match = message.match(new RegExp("in JSON at position (?<index>\\d+)(?: \\(line (?<line>\\d+) column (?<column>\\d+)\\))?$"));
  if (!match) {
    return;
  }
...
var _hasDate, _hasTime, _offset, _a4;
var TomlDate = (_a4 = class extends Date {
  constructor(date) {
    let hasDate = true;
    let hasTime = true;
    let offset = "Z";
...
}, _hasDate = new WeakMap(), _hasTime = new WeakMap(), _offset = new WeakMap(), _a4);
...
function parseValue(value, toml, ptr, integersAsBigInt) {
  ...
  if (value === "nan" || value === "+nan" || value === "-nan")
    return NaN;
  if (value === "-0")
    return integersAsBigInt ? /* @__PURE__ */ BigInt("0") : 0;
...
function peekTable(key2, table, meta, type) {
  ...
  for (let i = 0; i < key2.length; i++) {
    ...
    k = key2[i];
    if ((hasOwn = Object.hasOwn(t, k)) && ((_a10 = m[k]) == null ? void 0 : _a10.t) === 0 && ((_b = m[k]) == null ? void 0 : _b.d)) {
      return null;
    }
    if (!hasOwn) {
      if (k === "__proto__") {
...
function readFile(file) {
  return __async(this, null, function* () {
    ...
    try {
      return yield fs2.readFile(file, "utf8");
    } catch (error) {
...
function importModuleDefault(file) {
  return __async(this, null, function* () {
    const module = yield import(pathToFileURL2(file).href);
    return module.default;
  });
}
function readBunPackageJson(file) {
  return __async(this, null, function* () {
    try {
      return yield readJson(file);
    } catch (error) {
      try {
        return yield importModuleDefault(file);
      } catch (e) {
      }
      throw error;
    }
...
var loadConfigFromPackageJson = process.versions.bun ? function loadConfigFromBunPackageJson(file) {
  return __async(this, null, function* () {
    const { prettier } = yield readBunPackageJson(file);
    return prettier;
  });
} : function loadConfigFromPackageJson2(file) {
  return __async(this, null, function* () {
    const { prettier } = yield readJson(file);
    return prettier;
  });
};
function loadConfigFromPackageYaml(file) {
  return __async(this, null, function* () {
    const { prettier } = yield loadYaml(file);
    return prettier;
  });
}
var parseYaml;
...
function filter(_0) {
  return __async(this, arguments, function* ({ name, path: file }) {
    if (name === "package.json") {
      try {
        return Boolean(yield loadConfigFromPackageJson(file));
      } catch (e) {
        return false;
      }
    }
    if (name === "package.yaml") {
      try {
        return Boolean(yield loadConfigFromPackageYaml(file));
      } catch (e) {
        return false;
      }
    }
...
codes.ERR_INVALID_PACKAGE_CONFIG = createError(
   ...
   */
  (path152, base, message) => {
    return `Invalid package config ${path152}${base ? ` while importing ${base}` : ""}${message ? `. ${message}` : ""}`;
  },
  Error
);
...
codes.ERR_MODULE_NOT_FOUND = createError(
   ...
   */
  (path152, base, exactUrl = false) => {
    return `Cannot find ${exactUrl ? "module" : "package"} '${path152}' imported from ${base}`;
  },
  Error
);
...
codes.ERR_UNKNOWN_FILE_EXTENSION = createError(
   ...
   */
  (extension, path152) => {
    return `Unknown file extension "${extension}" for ${path152}`;
  },
  TypeError
);
...
function tryStatSync(path152) {
  try {
    return statSync(path152);
  } catch (e) {
  }
}
...
function loadExternalConfig(externalConfig, configFile) {
  return __async(this, null, function* () {
    try {
    ...
    const module = yield import_from_file_default(externalConfig, configFile);
    return module.default;
  });
}
...
function loadConfig(configFile) {
  return __async(this, null, function* () {
    ...
    let config = yield load(configFile);
    if (!config) {
      return;
    }
    if (typeof config === "string") {
      config = yield load_external_config_default(config, configFile);
    }
...
function loadPrettierConfig2(file, options8) {
  return __async(this, null, function* () {
    const shouldCache = options8.useCache;
    let configFile = options8.config;
    if (!configFile) {
      const directory = file ? path10.dirname(path10.resolve(file)) : void 0;
      configFile = yield searchPrettierConfig(directory, { shouldCache });
    }
    if (!configFile) {
      return;
    }
    configFile = toPath(configFile);
    const config = yield loadPrettierConfig(configFile, { shouldCache });
    return { config, configFile };
  });
}
function resolveConfig(fileUrlOrPath, options8) {
  return __async(this, null, function* () {
    options8 = __spreadValues({ useCache: true }, options8);
    const filePath = toPath(fileUrlOrPath);
    const [result, editorConfigured] = yield Promise.all([
    ...
    const merged = __spreadValues(__spreadValues({}, editorConfigured), mergeOverrides(result, filePath));
...
function resolveConfigFile(fileUrlOrPath) {
  return __async(this, null, function* () {
    const directory = fileUrlOrPath ? path10.dirname(path10.resolve(toPath(fileUrlOrPath))) : void 0;
    const result = yield searchPrettierConfig(directory, { shouldCache: false });
    return result != null ? result : null;
  });
}
function mergeOverrides(configResult, filePath) {
  const { config, configFile } = configResult || {};
  const _a10 = config || {}, { overrides } = _a10, options8 = __objRest(_a10, ["overrides"]);
...
var OPTIONAL_OBJECT2 = 1;
var createMethodShim2 = (methodName, getImplementation) => (flags, object, ...arguments_) => {
  var _a10;
  if (flags | OPTIONAL_OBJECT2 && (object === void 0 || object === null)) {
    return;
  }
  const implementation = (_a10 = getImplementation.call(object)) != null ? _a10 : object[methodName];
  return implementation.apply(object, arguments_);
...
var _a5;
var stringReplaceAll2 = (_a5 = String.prototype.replaceAll) != null ? _a5 : function(pattern, replacement) {
  if (pattern.global) {
    return this.replace(pattern, replacement);
  }
  return this.split(pattern).join(replacement);
};
var replaceAll2 = createMethodShim2("replaceAll", function() {
  if (typeof this === "string") {
    return stringReplaceAll2;
  }
});
var method_replace_all_default2 = replaceAll2;
var OPTION_CR2 = "cr";
var OPTION_CRLF2 = "crlf";
var OPTION_LF = "lf";
var DEFAULT_OPTION = OPTION_LF;
var CHARACTER_CR2 = "\r";
var CHARACTER_CRLF2 = "\r\n";
var CHARACTER_LF2 = "\n";
var DEFAULT_EOL2 = CHARACTER_LF2;
function guessEndOfLine(text) {
  const index = text.indexOf(CHARACTER_CR2);
  if (index !== -1) {
    return text.charAt(index + 1) === CHARACTER_LF2 ? OPTION_CRLF2 : OPTION_CR2;
  }
...
var regexps = /* @__PURE__ */ new Map([[CHARACTER_LF2, /\n/gu], [CHARACTER_CR2, /\r/gu], [CHARACTER_CRLF2, /\r\n/gu]]);
function countEndOfLineCharacters(text, endOfLineCharacter) {
  ...
  return (_b = (_a10 = text.match(regex)) == null ? void 0 : _a10.length) != null ? _b : 0;
}
...
var at2 = createMethodShim2("at", function() {
  if (Array.isArray(this) || typeof this === "string") {
    return stringOrArrayAt2;
  }
});
var method_at_default2 = at2;
var noop2 = () => {
};
var noop_default2 = noop2;
var DOC_TYPE_CURSOR2 = (
  /** @type {const} */
  "cursor"
);
var DOC_TYPE_INDENT2 = (
  /** @type {const} */
  "indent"
);
var DOC_TYPE_ALIGN2 = (
...
var DOC_TYPE_IF_BREAK2 = (
  /** @type {const} */
  "if-break"
);
var DOC_TYPE_INDENT_IF_BREAK2 = (
  /** @type {const} */
  "indent-if-break"
);
var DOC_TYPE_LINE_SUFFIX2 = (
  /** @type {const} */
  "line-suffix"
);
var DOC_TYPE_LINE_SUFFIX_BOUNDARY2 = (
  /** @type {const} */
  "line-suffix-boundary"
);
var DOC_TYPE_LINE2 = (
...
var DOC_TYPE_BREAK_PARENT2 = (
  /** @type {const} */
  "break-parent"
);
function inheritLabel(doc2, fn) {
  return doc2.type === DOC_TYPE_LABEL2 ? __spreadProps(__spreadValues({}, doc2), {
...
function flattenDoc(doc2) {
  ...
  if (doc2.type === DOC_TYPE_GROUP2) {
    return __spreadProps(__spreadValues({}, doc2), {
      ...
      expandedStates: (_a10 = doc2.expandedStates) == null ? void 0 : _a10.map(flattenDoc)
    });
  }
  ...
  if (doc2.contents) {
    return __spreadProps(__spreadValues({}, doc2), { contents: flattenDoc(doc2.contents) });
  }
  return doc2;
}
function printDocToDebug(doc2) {
  ...
  function printDoc(doc3, index, parentParts) {
    ...
    if (doc3.type === DOC_TYPE_LINE2) {
      const withBreakParent = ((_a10 = parentParts == null ? void 0 : parentParts[index + 1]) == null ? void 0 : _a10.type) === DOC_TYPE_BREAK_PARENT2;
      if (doc3.literal) {
...
var narrow_emojis_evaluate_default2 = "\xA9\xAE\u203C\u2049\u2122\u2139\u2194\u2195\u2196\u2197\u2198\u2199\u21A9\u21AA\u2328\u23CF\u23F1\u23F2\u23F8\u23F9\u23FA\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600\u2601\u2602\u2603\u2604\u260E\u2611\u2618\u261D\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638\u2639\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694\u2695\u2696\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F1\u26F7\u26F8\u26F9\u2702\u2708\u2709\u270C\u270D\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u2764\u27A1\u2934\u2935\u2B05\u2B06\u2B07";
var notAsciiRegex2 = /[^\x20-\x7F]/u;
var narrowEmojisSet2 = new Set(narrow_emojis_evaluate_default2);
function getStringWidth2(text) {
  ...
  for (const character of text) {
    ...
    width += isFullWidth2(codePoint) || isWide2(codePoint) ? 2 : 1;
  }
  return width;
}
...
var _AstPath_instances, getNodeStackIndex_fn, getAncestors_fn, _a6;
var AstPath = (_a6 = class {
  constructor(value) {
  ...
  get key() {
    ...
    return (_a10 = method_at_default2(
      /* OPTIONAL_OBJECT: false */
      0,
      stack2,
      siblings === null ? -2 : -4
  ...
  get siblings() {
    ...
    const maybeArray = method_at_default2(
      /* OPTIONAL_OBJECT: false */
      0,
      stack2,
      -3
  ...
  map(callback, ...names) {
    const result = [];
    this.each((path152, index, value) => {
      result[index] = callback(path152, index, value);
    }, ...names);
    return result;
  }
  /**
...
}, _AstPath_instances = new WeakSet(), getNodeStackIndex_fn = function(count) {
  const {
    stack: stack2
  } = this;
...
function getSortedChildNodes(node, ancestors, options8) {
  ...
  let childAncestors;
  const childNodes = ((_b = (_a10 = options8.getChildren) == null ? void 0 : _a10.call(options8, node, options8)) != null ? _b : [
    ...getChildren(node, { getVisitorKeys: options8.getVisitorKeys })
  ]).flatMap((child) => {
    childAncestors != null ? childAncestors : childAncestors = [node, ...ancestors];
...
function addCommentHelper(node, comment) {
  var _a10;
  const comments = (_a10 = node.comments) != null ? _a10 : node.comments = [];
...
function attachComments(ast, options8) {
  ...
  const decoratedComments = comments.map((comment, index) => __spreadProps(__spreadValues({}, decorateComment(ast, comment, options8)), {
    comment,
    text,
    options: options8,
    ast,
...
function breakTies(tiesToBreak, options8) {
  ...
  for (indexOfFirstLeadingComment = tieCount; indexOfFirstLeadingComment > 0; --indexOfFirstLeadingComment) {
    ...
    if ((_c = (_b = (_a10 = options8.printer).isGap) == null ? void 0 : _b.call(_a10, gap, options8)) != null ? _c : /^[\s(]*$/u.test(gap)) {
...
function printComment(path152, options8) {
  const comment = path152.node;
  comment.printed = true;
  return options8.printer.printComment(path152, options8);
}
function printLeadingComment(path152, options8) {
  var _a10;
  const comment = path152.node;
  const parts = [printComment(path152, options8)];
  const {
    printer: printer2,
    originalText,
    locStart,
  ...
  const isBlock = (_a10 = printer2.isBlockComment) == null ? void 0 : _a10.call(printer2, comment);
  if (isBlock) {
...
function printTrailingComment(path152, options8, previousComment) {
  var _a10;
  const comment = path152.node;
  const printed = printComment(path152, options8);
  const {
    printer: printer2,
    originalText,
    locStart
  ...
  const isBlock = (_a10 = printer2.isBlockComment) == null ? void 0 : _a10.call(printer2, comment);
  if ((previousComment == null ? void 0 : previousComment.hasLineSuffix) && !(previousComment == null ? void 0 : previousComment.isBlock) || has_newline_default(originalText, locStart(comment), {
    backwards: true
  })) {
...
function printCommentsSeparately(path152, options8) {
  const value = path152.node;
  if (!value) {
    return {};
  }
  const ignored = options8[/* @__PURE__ */ Symbol.for("printedComments")];
  ...
  path152.each(() => {
    ...
    if (leading) {
      leadingParts.push(printLeadingComment(path152, options8));
    } else if (trailing) {
      printedTrailingComment = printTrailingComment(path152, options8, printedTrailingComment);
...
function printComments(path152, doc2, options8) {
  const {
    leading,
    trailing
  } = printCommentsSeparately(path152, options8);
  if (!leading && !trailing) {
    return doc2;
  }
...
var create_print_pre_check_function_default = true ? () => noop_default2 : createPrintPreCheckFunction;
...
function getSupportInfo({
  ...
  const languages2 = plugins.flatMap((plugin) => {
    var _a10;
    return (_a10 = plugin.languages) != null ? _a10 : [];
  });
  const options8 = [];
  for (const option of normalizeOptionSettings(Object.assign({}, ...plugins.map(({
    ...
    option.pluginDefaults = Object.fromEntries(plugins.filter((plugin) => {
      var _a10;
      return ((_a10 = plugin.defaultOptions) == null ? void 0 : _a10[option.name]) !== void 0;
...
function normalizeOptionSettings(settings) {
  ...
  for (const [name, originalOption] of Object.entries(settings)) {
    ...
    if (Array.isArray(option.default)) {
      option.default = method_at_default2(
        /* OPTIONAL_OBJECT: false */
        0,
        option.default,
        -1
...
var _a7;
var arrayToReversed = (_a7 = Array.prototype.toReversed) != null ? _a7 : function() {
  return [...this].reverse();
};
var toReversed = createMethodShim2("toReversed", function() {
  if (Array.isArray(this)) {
    return arrayToReversed;
  }
});
var method_to_reversed_default = toReversed;
var import_n_readlines = __toESM2(require_readlines(), 1);
...
function getLanguageByFileName(languages2, file) {
  ...
  return (_a10 = languages2.find(({
    filenames
  }) => filenames == null ? void 0 : filenames.some((name) => name.toLowerCase() === basename))) != null ? _a10 : languages2.find(({
    extensions
...
function getLanguageByLanguageName(languages2, languageName) {
  ...
  return (_b = (_a10 = languages2.find(({
    name
  }) => name.toLowerCase() === languageName)) != null ? _a10 : languages2.find(({
    aliases
  }) => aliases == null ? void 0 : aliases.includes(languageName))) != null ? _b : languages2.find(({
    extensions
...
function getLanguageByIsSupported(languages2, file) {
  ...
  return languages2.find(({
    isSupported
  }) => isSupported == null ? void 0 : isSupported({
    filepath: file
  }));
}
function inferParser(options8, fileInfo) {
  ...
  const languages2 = method_to_reversed_default(
    ...
    return (
      ...
      (_a11 = plugin.languages) != null ? _a11 : []
    );
  });
  const language = (_e = (_d = (_c = (_b = (_a10 = getLanguageByLanguageName(languages2, fileInfo.language)) != null ? _a10 : getLanguageByFileName(languages2, fileInfo.physicalFile)) != null ? _b : getLanguageByFileName(languages2, fileInfo.file)) != null ? _c : getLanguageByIsSupported(languages2, fileInfo.physicalFile)) != null ? _d : getLanguageByIsSupported(languages2, fileInfo.file)) != null ? _e : getLanguageByInterpreter == null ? void 0 : getLanguageByInterpreter(languages2, fileInfo.physicalFile);
...
function normalizeOptions(options8, optionInfos, {
  ...
  const unknown = !passThrough ? (key2, value, options9) => {
    const _a10 = options9.schemas, {
      _
    } = _a10, schemas2 = __objRest(_a10, [
      "_"
    ]);
    return levenUnknownHandler(key2, value, __spreadProps(__spreadValues({}, options9), {
      schemas: schemas2
    }));
...
function optionInfoToSchema(optionInfo, {
  ...
  switch (optionInfo.type) {
    ...
    case "choice":
      ...
      parameters.choices = optionInfo.choices.map((choiceInfo) => (choiceInfo == null ? void 0 : choiceInfo.redirect) ? __spreadProps(__spreadValues({}, choiceInfo), {
        redirect: {
          to: {
            key: optionInfo.name,
  ...
  return optionInfo.array ? ArraySchema.create(__spreadProps(__spreadValues(__spreadValues({}, isCLI ? {
    preprocess: (v) => Array.isArray(v) ? v : [v]
  } : {}), handlers), {
    // @ts-expect-error
    valueSchema: SchemaConstructor.create(parameters)
  })) : SchemaConstructor.create(__spreadValues(__spreadValues({}, parameters), handlers));
}
var normalize_options_default = normalizeOptions;
var _a8;
var arrayFindLast = (_a8 = Array.prototype.findLast) != null ? _a8 : function(callback) {
...
var findLast = createMethodShim2("findLast", function() {
  if (Array.isArray(this)) {
...
function isFrontMatter(node) {
  return Boolean(node == null ? void 0 : node[FRONT_MATTER_MARK]);
}
...
function printEmbedFrontMatter(textToDoc2, print, path152, options8) {
  return __async(this, null, function* () {
    var _a10;
    const {
      node
    ...
    if (value) {
      ...
      doc2 = value ? yield textToDoc2(value, {
        parser
      }) : "";
    } else {
      doc2 = value;
    }
    return markAsRoot2([node.startDelimiter, (_a10 = node.explicitLanguage) != null ? _a10 : "", hardline22, doc2, doc2 ? hardline22 : "", node.endDelimiter]);
  });
}
...
function initPrinter(plugin, astFormat) {
  return __async(this, null, function* () {
    ...
    const printer2 = typeof printerOrPrinterInitFunction === "function" ? yield printerOrPrinterInitFunction() : printerOrPrinterInitFunction;
...
function normalizePrinter(printer2) {
  ...
  if (false) {
    ok(!printer2[PRINTER_NORMALIZED_MARK], "Unexpected printer normalization");
  }
  let _a10 = printer2, {
    features,
    getVisitorKeys,
    ...
    print: originalPrint
  } = _a10, printerRestProperties = __objRest(_a10, [
    "features",
    "getVisitorKeys",
    "embed",
    "massageAstNode",
    ...
    embed = new Proxy(originalEmbed, {
      get(target, property, receiver) {
        if (property === "getVisitorKeys") {
          embedGetVisitorKeys != null ? embedGetVisitorKeys : embedGetVisitorKeys = originalEmbed.getVisitorKeys ? create_get_visitor_keys_function_default(
  ...
  if (frontMatterSupport.print) {
    print = new Proxy(originalPrint, {
      apply(target, thisArgument, argumentsList) {
        const [path152] = argumentsList;
        if (is_front_matter_default(path152.node)) {
          return print_default(path152);
        }
        return Reflect.apply(target, thisArgument, argumentsList);
      }
    });
  }
  const normalizedPrinter = __spreadValues({
    features,
    getVisitorKeys,
    embed,
    massageAstNode,
  ...
  normalizedPrinters.set(printer2, normalizedPrinter);
...
function normalizePrinterFrontMatterSupport(frontMatterSupport) {
  return __spreadValues(__spreadValues({}, PRINTER_FRONT_MATTER_SUPPORT_OFF), frontMatterSupport);
}
function normalizePrinterFeatures(features) {
  return __spreadProps(__spreadValues({
    experimental_avoidAstMutation: false
  }, features), {
    experimental_frontMatterSupport: normalizePrinterFrontMatterSupport(features == null ? void 0 : features.experimental_frontMatterSupport)
  });
}
...
function normalizeFormatOptions(_0) {
  return __async(this, arguments, function* (options8, opts = {}) {
    var _a10;
    const rawOptions = __spreadValues({}, options8);
    ...
    const defaults = __spreadValues(__spreadValues({}, formatOptionsHiddenDefaults), Object.fromEntries(
    ...
    const parser = yield initParser(parserPlugin, rawOptions.parser);
    rawOptions.astFormat = parser.astFormat;
    rawOptions.locEnd = parser.locEnd;
    rawOptions.locStart = parser.locStart;
    const printerPlugin = ((_a10 = parserPlugin.printers) == null ? void 0 : _a10[parser.astFormat]) ? parserPlugin : getPrinterPluginByAstFormat(rawOptions.plugins, parser.astFormat);
    const printer2 = yield initPrinter(printerPlugin, parser.astFormat);
    ...
    const mixedDefaults = __spreadValues(__spreadValues({}, defaults), pluginDefaults);
    ...
    return normalize_options_default(rawOptions, supportOptions, __spreadValues({
      passThrough: Object.keys(formatOptionsHiddenDefaults)
    }, opts));
  });
}
var normalize_format_options_default = normalizeFormatOptions;
function parse5(originalText, options8) {
  return __async(this, null, function* () {
    const parser = yield resolveParser(options8);
    const text = parser.preprocess ? yield parser.preprocess(originalText, options8) : originalText;
    options8.originalText = text;
    let ast;
    try {
      ast = yield parser.parse(
        text,
        options8,
...
function printEmbeddedLanguages(path152, genericPrint, options8, printAstToDoc2, embeds) {
  return __async(this, null, function* () {
    ...
    recurse();
    const originalPathStack = path152.stack;
    for (const {
      print,
      node,
      pathStack
      ...
      try {
        path152.stack = pathStack;
        const doc2 = yield print(textToDocForEmbed, genericPrint, path152, options8);
        if (doc2) {
    ...
    path152.stack = originalPathStack;
    ...
    function recurse() {
      ...
      if (node === null || typeof node !== "object" || (hasPrettierIgnore == null ? void 0 : hasPrettierIgnore(path152))) {
        return;
      }
      for (const key2 of getVisitorKeys(node)) {
        if (Array.isArray(node[key2])) {
          path152.each(recurse, key2);
        } else {
          path152.call(recurse, key2);
        }
      }
      const result = embed(path152, options8);
      if (!result) {
        return;
      }
...
function textToDoc(text, partialNextOptions, parentOptions, printAstToDoc2) {
  return __async(this, null, function* () {
    const options8 = yield normalize_format_options_default(__spreadProps(__spreadValues(__spreadValues({}, parentOptions), partialNextOptions), {
    ...
    const {
      ast
    } = yield parse_default(text, options8);
    const doc2 = yield printAstToDoc2(ast, options8);
    return stripTrailingHardline2(doc2);
  });
}
function printIgnored(path152, options8, printPath, args) {
  const {
    originalText,
    [/* @__PURE__ */ Symbol.for("comments")]: comments,
    locStart,
  ...
  return printPrettierIgnored ? printPrettierIgnored(path152, options8, printPath, args) : originalText.slice(start, end);
}
var print_ignored_default = printIgnored;
var {
  cursor: cursor2
} = builders;
function printAstToDoc(ast, options8) {
  return __async(this, null, function* () {
    ({
      ast
    } = yield prepareToPrint(ast, options8));
    ...
    yield printEmbeddedLanguages(path152, mainPrint, options8, printAstToDoc, embeds);
    const doc2 = yield callPluginPrintFunction(path152, options8, mainPrint, void 0, embeds);
    ...
    function mainPrint(selector, args) {
      if (selector === void 0 || selector === path152) {
        return mainPrintInternal(args);
      }
      if (Array.isArray(selector)) {
        return path152.call(() => mainPrintInternal(args), ...selector);
      }
      return path152.call(() => mainPrintInternal(args), selector);
    }
    function mainPrintInternal(args) {
      ensurePrintingNode(path152);
      const value = path152.node;
...
function callPluginPrintFunction(path152, options8, printPath, args, embeds) {
  var _a10, _b;
  const {
    node
  } = path152;
  ...
  let doc2;
  if ((_a10 = printer2.hasPrettierIgnore) == null ? void 0 : _a10.call(printer2, path152)) {
    doc2 = print_ignored_default(path152, options8, printPath, args);
  } else if (embeds.has(node)) {
    doc2 = embeds.get(node);
  } else {
    doc2 = printer2.print(path152, options8, printPath, args);
  }
  switch (node) {
  ...
  if (printer2.printComment && !((_b = printer2.willPrintOwnComments) == null ? void 0 : _b.call(printer2, path152, options8))) {
    doc2 = printComments(path152, doc2, options8);
  }
  return doc2;
}
function prepareToPrint(ast, options8) {
  return __async(this, null, function* () {
    var _a10;
    const comments = (_a10 = ast.comments) != null ? _a10 : [];
    options8[/* @__PURE__ */ Symbol.for("comments")] = comments;
    options8[/* @__PURE__ */ Symbol.for("printedComments")] = /* @__PURE__ */ new Set();
    ...
    ast = preprocess ? yield preprocess(ast, options8) : ast;
    return {
      ast,
      comments
    };
...
function massageAst(ast, options8) {
  ...
  function recurse(original, parent) {
    ...
    for (const key2 in original) {
      if (!Object.prototype.hasOwnProperty.call(original, key2) || (ignoredProperties == null ? void 0 : ignoredProperties.has(key2))) {
        continue;
      }
    ...
    return result != null ? result : cloned;
  }
}
var massage_ast_default = massageAst;
var _a9;
var arrayFindLastIndex = (_a9 = Array.prototype.findLastIndex) != null ? _a9 : function(callback) {
  for (let index = this.length - 1; index >= 0; index--) {
    const element = this[index];
    if (callback(element, index, this)) {
      return index;
...
var findLastIndex = createMethodShim2("findLastIndex", function() {
  if (Array.isArray(this)) {
...
function coreFormat(originalText, opts, addAlignmentSize = 0) {
  return __async(this, null, function* () {
    ...
    const {
      ast,
      text
    } = yield parse_default(originalText, opts);
    if (opts.cursorOffset >= 0) {
      opts = __spreadValues(__spreadValues({}, opts), get_cursor_node_default(ast, opts));
    }
    let doc2 = yield printAstToDoc(ast, opts, addAlignmentSize);
    if (addAlignmentSize > 0) {
      doc2 = addAlignmentToDoc2([hardline3, doc2], addAlignmentSize, opts.tabWidth);
    }
    ...
    if (addAlignmentSize > 0) {
      ...
      result.formatted = trimmed + convertEndOfLineOptionToCharacter2(opts.endOfLine);
    }
    const comments = opts[/* @__PURE__ */ Symbol.for("comments")];
    if (opts.cursorOffset >= 0) {
...
function formatRange(originalText, opts) {
  return __async(this, null, function* () {
    ...
    const [rangeStart, rangeEnd] = (_a10 = calculateRange(text, opts, ast)) != null ? _a10 : [0, 0];
    ...
    const rangeResult = yield coreFormat(rangeString, __spreadProps(__spreadValues({}, opts), {
      rangeStart: 0,
    ...
    if (opts.endOfLine !== "lf") {
      const eol = convertEndOfLineOptionToCharacter2(opts.endOfLine);
...
function normalizeIndexes(text, options8) {
  ...
  return __spreadProps(__spreadValues({}, options8), {
    cursorOffset,
    rangeStart,
    rangeEnd
  });
...
function normalizeInputAndOptions(text, options8) {
  ...
  return {
    hasBOM,
    text,
    options: normalizeIndexes(text, __spreadProps(__spreadValues({}, options8), {
      cursorOffset,
      rangeStart,
      rangeEnd,
      endOfLine
...
function hasPragma(text, options8) {
  return __async(this, null, function* () {
    const selectedParser = yield resolveParser(options8);
    return !selectedParser.hasPragma || selectedParser.hasPragma(text);
  });
}
function hasIgnorePragma(text, options8) {
  return __async(this, null, function* () {
    var _a10;
    const selectedParser = yield resolveParser(options8);
    return (_a10 = selectedParser.hasIgnorePragma) == null ? void 0 : _a10.call(selectedParser, text);
  });
}
function formatWithCursor(originalText, originalOptions) {
  return __async(this, null, function* () {
    let {
      ...
      text,
      options: options8
    } = normalizeInputAndOptions(originalText, yield normalize_format_options_default(originalOptions));
    if (options8.rangeStart >= options8.rangeEnd && text !== "" || options8.requirePragma && !(yield hasPragma(text, options8)) || options8.checkIgnorePragma && (yield hasIgnorePragma(text, options8))) {
      return {
    ...
    if (options8.rangeStart > 0 || options8.rangeEnd < text.length) {
      result = yield formatRange(text, options8);
    } else {
      if (!options8.requirePragma && options8.insertPragma && options8.printer.insertPragma && !(yield hasPragma(text, options8))) {
        text = options8.printer.insertPragma(text);
      }
      result = yield coreFormat(text, options8);
    }
    if (hasBOM) {
...
function parse6(originalText, originalOptions, devOptions) {
  return __async(this, null, function* () {
    const {
      text,
      options: options8
    } = normalizeInputAndOptions(originalText, yield normalize_format_options_default(originalOptions));
    const parsed = yield parse_default(text, options8);
    if (devOptions) {
      if (devOptions.preprocessForPrint) {
        parsed.ast = yield prepareToPrint(parsed.ast, options8);
      }
...
function formatAst(ast, options8) {
  return __async(this, null, function* () {
    options8 = yield normalize_format_options_default(options8);
    const doc2 = yield printAstToDoc(ast, options8);
...
function formatDoc(doc2, options8) {
  return __async(this, null, function* () {
    ...
    const {
      formatted
    } = yield formatWithCursor(text, __spreadProps(__spreadValues({}, options8), {
      parser: "__js_expression"
    }));
    return formatted;
  });
}
function printToDoc(originalText, options8) {
  return __async(this, null, function* () {
    options8 = yield normalize_format_options_default(options8);
    const {
      ast
    } = yield parse_default(originalText, options8);
    if (options8.cursorOffset >= 0) {
      options8 = __spreadValues(__spreadValues({}, options8), get_cursor_node_default(ast, options8));
    }
...
function printDocToString2(doc2, options8) {
  return __async(this, null, function* () {
    return printDocToStringWithoutNormalizeOptions(doc2, yield normalize_format_options_default(options8));
  });
}
...
function createParsersAndPrinters(modules) {
  ...
  for (const {
    ...
    const loadPlugin2 = () => __async(null, null, function* () {
      const plugin = yield importPlugin2();
      Object.assign(parsers2, plugin.parsers);
      Object.assign(printers2, plugin.printers);
      return plugin;
    });
    for (const parserName of parserNames) {
      parsers2[parserName] = () => __async(null, null, function* () {
        return (yield loadPlugin2()).parsers[parserName];
      });
    }
    for (const printerName of printerNames) {
      printers2[printerName] = () => __async(null, null, function* () {
        return (yield loadPlugin2()).printers[printerName];
      });
    }
  }
...
var options7 = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, options_default), options_default2), options_default3), options_default4), options_default5), options_default6);
var languages = [
...
function importPlugin(name, cwd) {
  return __async(this, null, function* () {
    if (isUrl(name)) {
      return import(name);
    }
    ...
    try {
      return yield import(pathToFileURL5(path13.resolve(name)).href);
    } catch (e) {
      return import_from_directory_default(name, cwd);
    }
  });
}
function loadPluginWithoutCache(plugin, cwd) {
  return __async(this, null, function* () {
    var _a10;
    const module = yield importPlugin(plugin, cwd);
    const implementation = (_a10 = module.default) != null ? _a10 : module;
    const name = isUrl(plugin) ? toPath(plugin) : plugin;
    return __spreadValues({ name }, implementation);
  });
}
...
var slash = path14.sep === "\\" ? (filePath) => method_replace_all_default2(
  /* OPTIONAL_OBJECT: false */
  0,
  filePath,
  "\\",
...
function createSingleIsIgnoredFunction(ignoreFile, withNodeModules) {
  return __async(this, null, function* () {
    ...
    let content = "";
    if (ignoreFile) {
      content += (_a10 = yield read_file_default(ignoreFile)) != null ? _a10 : "";
    }
    if (!withNodeModules) {
      content += "\nnode_modules";
    }
...
function createIsIgnoredFunction(ignoreFiles, withNodeModules) {
  return __async(this, null, function* () {
    ...
    const isIgnoredFunctions = (yield Promise.all(ignoreFiles.map((ignoreFile) => createSingleIsIgnoredFunction(ignoreFile, withNodeModules)))).filter(Boolean);
    return (file) => isIgnoredFunctions.some((isIgnored2) => isIgnored2(file));
  });
}
function isIgnored(file, options8) {
  return __async(this, null, function* () {
    const {
      ignorePath: ignoreFiles,
      withNodeModules
    } = options8;
    const isIgnored2 = yield createIsIgnoredFunction(ignoreFiles, withNodeModules);
...
function getFileInfo(_0) {
  return __async(this, arguments, function* (file, options8 = {}) {
    var _a10;
    ...
    const ignored = yield isIgnored(file, { ignorePath, withNodeModules });
    let inferredParser;
    if (!ignored) {
      inferredParser = (_a10 = options8.parser) != null ? _a10 : yield getParser(file, options8);
    }
    return {
      ignored,
      inferredParser: inferredParser != null ? inferredParser : null
    };
  });
}
function getParser(file, options8) {
  return __async(this, null, function* () {
    var _a10, _b;
    let config;
    if (options8.resolveConfig !== false) {
      config = yield resolveConfig(file, {
    ...
    let plugins = (_b = (_a10 = options8.plugins) != null ? _a10 : config == null ? void 0 : config.plugins) != null ? _b : [];
    plugins = (yield Promise.all([load_builtin_plugins_default(), load_plugins_default(plugins)])).flat();
...
function makeString(rawText, enclosingQuote, unescapeUnnecessaryEscapes) {
  ...
  const regex = new RegExp(`\\\\(.)|(["'])`, "gsu");
  const raw = method_replace_all_default2(
    /* OPTIONAL_OBJECT: false */
    0,
    rawText,
    regex,
...
function withPlugins(fn, optionsArgumentIndex = 1) {
  return (...args) => __async(null, null, function* () {
    var _a10;
    const options8 = (_a10 = args[optionsArgumentIndex]) != null ? _a10 : {};
    const { plugins = [] } = options8;
    args[optionsArgumentIndex] = __spreadProps(__spreadValues({}, options8), {
      plugins: (yield Promise.all([
...
function format2(text, options8) {
  return __async(this, null, function* () {
    const { formatted } = yield formatWithCursor2(text, __spreadProps(__spreadValues({}, options8), {
      cursorOffset: -1
    }));
    return formatted;
  });
}
function check(text, options8) {
  return __async(this, null, function* () {
    return (yield format2(text, options8)) === text;
  });
}
...
var sharedWithCli = {
  ...
  inferParser: (file, options8) => {
    var _a10;
    return Promise.resolve((_a10 = options8 == null ? void 0 : options8.parser) != null ? _a10 : inferParser2(file, options8));
  },
  vnopts: {
    ChoiceSchema,
    apiDescriptor
...
// trabecula/utils/generator/files.ts
var ROOT_PATH = path15.resolve(".", "trabecula");
var createFiles = (folder, fileDefs) => __async(null, null, function* () {
  try {
    yield fs4.mkdir(folder, { recursive: true });
...
var formatFile = (str) => index_exports.format(str, { parser: "typescript", printWidth: 100, tabWidth: 2, useTabs: false });
...
var parseExports = (filePath) => __async(null, null, function* () {
  var _a10;
  const fileContent = yield fs4.readFile(filePath, { encoding: "utf-8" });
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    const match = line3.match(fnRegEx);
    if (match) {
      const prevLine = (_a10 = lines[i - 1]) == null ? void 0 : _a10.trim();
...
var parseExportsFromIndex = (indexFilePath) => __async(null, null, function* () {
  const indexContent = yield fs4.readFile(indexFilePath, { encoding: "utf-8" });
  ...
  const exportsMap = yield Promise.all(
    fileNames.map(
      (fileName) => parseExports(path15.join(path15.dirname(indexFilePath), `${fileName}.ts`))
    )
  );
