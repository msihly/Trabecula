...
var mt = (t, e) => (n, r, ...s) => {
  var _a4;
  return n | 1 && r == null ? void 0 : ((_a4 = e.call(r)) != null ? _a4 : r[t]).apply(r, s);
};
function Ri(t) {
...
var D = Di;
var _a;
var $i = (_a = String.prototype.replaceAll) != null ? _a : function(t, e) {
...
function ln(t, e) {
  return Pe(t[0], __spreadProps(__spreadValues({}, e), { expandedStates: t }));
}
function ze(t, e = "", n = {}) {
...
function Tt(t) {
  return (e, n, r) => {
    let s = !!(r == null ? void 0 : r.backwards);
...
` || t === "\r" || t === "\u2028" || t === "\u2029";
function ji(t, e, n) {
  let r = !!(n == null ? void 0 : n.backwards);
...
function Tr(t, e) {
  let { node: n } = t;
  if (n.type === "root" && e.filepath && /(?:[/\\]|^)\.(?:prettier|stylelint|lintstaged)rc$/u.test(e.filepath)) return (r) => __async(null, null, function* () {
    let s = yield r(e.originalText, { parser: "json" });
    return s ? [s, N] : void 0;
  });
}
Tr.getVisitorKeys = () => [];
...
function et(t) {
  ...
  return Ze = et.prototype = t != null ? t : /* @__PURE__ */ Object.create(null), new et();
}
var Gi = 10;
...
function dn(t, e, n) {
  return e("children" in t ? __spreadProps(__spreadValues({}, t), { children: t.children.map((r) => dn(r, e, t)) }) : t, n);
}
function Ie(t, e, n) {
...
function $r(t, { parentIndent: e, isLastDescendant: n, options: r }) {
  ...
  if (t.indent === null) {
    let l = s.match(new RegExp("^(?<leadingSpace> *)[^\\n\\r ]", "mu"));
...
function Pt(t, e, n) {
  ...
  let c = D(0, r.children, -1), l = (c == null ? void 0 : c.type) === "flowMappingItem" && _e(c.key) && _e(c.value);
...
function to(t, e, n) {
  ...
  if (a && c) return ": ";
  let l = n("key"), f = no(r) ? " " : "";
  if (c) return r.type === "flowMappingItem" && s.type === "flowMapping" ? l : r.type === "mappingItem" && Sn(i.content, e) && !K(i.content) && ((_a4 = s.tag) == null ? void 0 : _a4.value) !== "tag:yaml.org,2002:set" ? [l, f, ":"] : ["? ", _(2, l)];
  let m = n("value");
  if (a) return [": ", _(2, m)];
...
function no(t) {
  var _a4;
  return ((_a4 = t.key.content) == null ? void 0 : _a4.type) === "alias";
}
function ro(t) {
  if (!t) return true;
  switch (t.type) {
...
function Is(t) {
  F(t);
  let e = _a2(t), n = t.children.slice();
...
function q() {
  return __spreadValues(__spreadValues({}, z()), he());
}
function Bs(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("alias", t)), q()), e), { value: n });
}
function Fs(t, e) {
  let n = t.cstNode;
...
function Us(t, e, n, r, s, i) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("blockValue", t)), z()), e), { chomping: n, indent: r, value: s, indicatorComment: i });
}
var Jn;
(function(t) {
...
function Qs(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues({}, b("directive", t)), q()), { name: e, parameters: n });
}
function We(t, e) {
...
function Hs(t, e, n, r, s, i) {
  return __spreadProps(__spreadValues(__spreadValues({}, b("document", t)), he(i)), { directivesEndMarker: e, documentEndMarker: n, children: [r, s] });
}
function U(t = []) {
  return { endComments: t };
}
function Js(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues({}, b("documentBody", t)), U(n)), { children: e ? [e] : [] });
}
function V(t) {
  return t[t.length - 1];
}
...
function zs(t, e, n, r) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("documentHead", t)), U(n)), he(r)), { children: e });
}
function Zs(t, e) {
...
function zt(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, b("flowCollection", t)), q()), U()), e), { children: n });
}
function ti(t, e, n) {
  return __spreadProps(__spreadValues({}, zt(t, e, n)), { type: "flowMapping" });
}
function Zt(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues({}, b("flowMappingItem", t)), z()), { children: [e, n] });
}
function de(t, e) {
  let n = [];
...
function Xn(t, e) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("mappingKey", t)), he()), U()), { children: e ? [e] : [] });
}
function zn(t, e) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("mappingValue", t)), q()), U()), { children: e ? [e] : [] });
}
...
function ri(t, e, n) {
  return __spreadProps(__spreadValues({}, zt(t, e, n)), { type: "flowSequence" });
}
function si(t, e) {
...
function oi(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("mapping", t)), z()), e), { children: n });
}
function ai(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues({}, b("mappingItem", t)), z()), { children: [e, n] });
}
function ci(t, e) {
  let n = t.cstNode;
...
function li(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("plain", t)), q()), e), { value: n });
}
function fi(t, e, n) {
...
function mi(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("quoteValue", t)), e), q()), { value: n });
}
function rn(t, e) {
  let n = t.cstNode;
...
function yi(t, e, n) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, b("sequence", t)), z()), U()), e), { children: n });
}
function Ei(t, e) {
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, b("sequenceItem", t)), q()), U()), { children: e ? [e] : [] });
}
function Si(t, e) {
...
var Zn;
var _e2, _t, _er_instances, n_fn, r_fn, _a3;
var er = (_a3 = class {
  constructor(e, n) {
    ...
    this.text = n, __privateSet(this, _e2, e);
  }
  setOrigRanges() {
    if (!__privateGet(this, _e2).setOrigRanges()) for (let e of __privateGet(this, _e2)) e.setOrigRanges([], 0);
  }
  transformOffset(e) {
    return __privateMethod(this, _er_instances, n_fn).call(this, { origStart: e, origEnd: e }).start;
  }
  transformRange(e) {
    let { start: n, end: r } = __privateMethod(this, _er_instances, n_fn).call(this, e);
    return X(n, r);
  }
  transformNode(e) {
    return wi(e, this);
...
}, _e2 = new WeakMap(), _t = new WeakMap(), _er_instances = new WeakSet(), n_fn = function(e) {
  var _a4;
  if (!Zn) {
    let [o] = __privateGet(this, _e2), a = Object.getPrototypeOf(Object.getPrototypeOf(o));
    Zn = Object.getOwnPropertyDescriptor(a, "rangeAsLinePos").get;
  }
  if ((_a4 = __privateGet(this, _t)) != null ? _a4 : __privateSet(this, _t, { root: { context: { src: this.text } } }), this.text === "" && e.origStart === 0 && e.origEnd === 0) return { start: { offset: 0, line: 1, column: 1 }, end: { offset: 0, line: 1, column: 1 } };
  let { start: { line: n, col: r }, end: { line: s, col: i } } = Zn.call({ range: { start: __privateMethod(this, _er_instances, r_fn).call(this, e.origStart), end: __privateMethod(this, _er_instances, r_fn).call(this, e.origEnd) }, context: __privateGet(this, _t) });
...
function Ga(t) {
  try {
    ...
    throw (e == null ? void 0 : e.position) ? Li(e.message, { loc: e.position, cause: e }) : e;
  }
}
