...
var ft = w((gx, Mi) => {
  ...
  var Uc = ut(), ct = class extends Uc {
    ...
    constructor(e) {
      e && typeof e.value < "u" && typeof e.value != "string" && (e = __spreadProps(__spreadValues({}, e), { value: String(e.value) })), super(e), this.type = "decl";
    }
  };
  Mi.exports = ct;
  ct.default = ct;
...
var sr = w((Wx, Mo) => {
  ...
  var kf = fe(), Lo, Do, be = class extends kf {
    constructor(e) {
      super(__spreadValues({ type: "document" }, e)), this.nodes || (this.nodes = []);
    }
    toResult(e = {}) {
...
var Uo = w((Gx, Bo) => {
  ...
  function dt(t, e) {
    ...
    let _a3 = t, { inputs: s } = _a3, r = __objRest(_a3, ["inputs"]);
    if (s) {
      e = [];
      for (let n of s) {
        let i = __spreadProps(__spreadValues({}, n), { __proto__: Cf.prototype });
        i.map && (i.map = __spreadProps(__spreadValues({}, i.map), { __proto__: Nf.prototype })), e.push(i);
      }
    }
    if (r.nodes && (r.nodes = t.nodes.map((n) => dt(n, e))), r.source) {
      let _b = r.source, { inputId: n } = _b, i = __objRest(_b, ["inputId"]);
...
var As = w((Qx, Ho) => {
  ...
  var Ts = {}, he = class t {
    ...
    constructor(e, s, r) {
      ...
      this.result = new Vo(e, n, r), this.helpers = __spreadProps(__spreadValues({}, Ts), { postcss: Ts, result: this.result }), this.plugins = this.processor.plugins.map((i) => typeof i == "object" && i.prepare ? __spreadValues(__spreadValues({}, i), i.prepare(this.result)) : i);
    }
    async() {
...
var bt = (t, e) => (s, r, ...n) => {
  var _a3;
  return s | 1 && r == null ? void 0 : ((_a3 = e.call(r)) != null ? _a3 : r[t]).apply(r, n);
};
var _a2;
var Ol = (_a2 = String.prototype.replaceAll) != null ? _a2 : function(t, e) {
  ...
  function n(i) {
    switch (ue(i)) {
      ...
      case oe: {
        ...
        return o ? (o = o.map(r), u = o[0]) : u = r(u), e(__spreadProps(__spreadValues({}, i), { contents: u, expandedStates: o }));
      }
      case Ae:
      case ie:
      case kt:
...
var hn = zl;
function jl(t, e) {
  K(new RegExp(`^(?<quote>["']).*\\k<quote>$`, "su").test(t));
...
var dn = jr;
var Pt = /* @__PURE__ */ Symbol.for("PRETTIER_IS_FRONT_MATTER");
function Hl(t) {
...
function mn(t, e, s) {
  ...
  if (t.type === "value-root" && delete e.text, (t.type === "media-query" || t.type === "media-query-list" || t.type === "media-feature-expression") && delete e.value, t.type === "css-rule" && delete e.params, (t.type === "media-feature" || t.type === "media-keyword" || t.type === "media-type" || t.type === "media-unknown" || t.type === "media-url" || t.type === "media-value" || t.type === "selector-attribute" || t.type === "selector-string" || t.type === "selector-class" || t.type === "selector-combinator" || t.type === "value-string") && t.value && (e.value = Jl(t.value)), t.type === "selector-combinator" && (e.value = E(0, e.value, /\s+/gu, " ")), t.type === "media-feature" && (e.value = E(0, e.value, " ", "")), (t.type === "value-word" && (t.isColor && t.isHex || ["initial", "inherit", "unset", "revert"].includes(t.value.toLowerCase())) || t.type === "media-feature" || t.type === "selector-root-invalid" || t.type === "selector-pseudo") && (e.value = e.value.toLowerCase()), t.type === "css-decl" && (e.prop = t.prop.toLowerCase()), (t.type === "css-atrule" || t.type === "css-import") && (e.name = t.name.toLowerCase()), t.type === "value-number" && (e.unit = t.unit.toLowerCase()), t.type === "value-unknown" && (e.value = E(0, e.value, /;$/gu, "")), t.type === "selector-attribute" && (e.attribute = t.attribute.trim(), t.namespace && typeof t.namespace == "string" && (e.namespace = t.namespace.trim() || true), t.value)) {
    let { value: r } = e;
    /\s[a-zA-Z]$/u.test(r) && (e.__prettier_attribute_selector_flag = G(0, r, -1), r = r.slice(0, -1)), r = r.trim(), r = r.replace(new RegExp(`^(?<quote>["'])(?<value>.*?)\\k<quote>$`, "u"), "$<value>"), e.value = r, delete e.quoted;
  }
...
function Xe(t) {
  ...
  return Qe = Xe.prototype = t != null ? t : /* @__PURE__ */ Object.create(null), new Xe();
}
var Zl = 10;
...
function Sn(t, e) {
  var _a3, _b, _c2;
  if (typeof ((_b = (_a3 = t.source) == null ? void 0 : _a3.start) == null ? void 0 : _b.offset) == "number") return t.source.start.offset;
...
function Qr(t, e) {
  ...
  if (typeof ((_b = (_a3 = t.source) == null ? void 0 : _a3.end) == null ? void 0 : _b.offset) == "number") return t.source.end.offset;
  if (t.source) {
    if (t.source.end) {
...
function sc(t) {
  ...
  return typeof t.prop == "string" && (e += t.prop.length), t.type === "css-atrule" && typeof t.name == "string" && (e += 1 + t.name.length + t.raws.afterName.match(/^\s*:?\s*/u)[0].length), t.type !== "css-atrule" && typeof ((_a3 = t.raws) == null ? void 0 : _a3.between) == "string" && (e += t.raws.between.length), e;
}
function Tn(t) {
...
var P = (t) => {
  var _a3;
  return (_a3 = t.source) == null ? void 0 : _a3.startOffset;
};
var R = (t) => {
  var _a3;
  return (_a3 = t.source) == null ? void 0 : _a3.endOffset;
};
var nc = /\*\/$/;
var ic = /^\/\*\*?/;
var Nn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/;
...
function In(t) {
  var _a3;
  let s = (_a3 = t.match(Nn)) == null ? void 0 : _a3[0];
...
function Wn(t) {
  let { shebang: e, text: s, pragmas: r, comments: n } = Jr(t), i = In(s), o = Ln({ pragmas: __spreadValues({ [Bn]: "" }, r), comments: n.trimStart() });
  return (e ? `${e}
` : "") + o + (i.startsWith(`
`) ? `
` : `
...
function zn(t) {
  var _a3, _b;
  return (_b = (_a3 = t.findAncestor((e) => e.type === "css-decl")) == null ? void 0 : _a3.prop) == null ? void 0 : _b.toLowerCase();
}
...
function Hn(t, e) {
  var _a3, _b;
  return ((_b = (_a3 = t.findAncestor((r) => r.type === "css-atrule")) == null ? void 0 : _a3.name) == null ? void 0 : _b.toLowerCase().endsWith("keyframes")) && ["from", "to"].includes(e.toLowerCase());
}
function Ie(t) {
...
function qe(t, e) {
  var _a3, _b;
  return ((_b = (_a3 = t.findAncestor((r) => r.type === "value-func")) == null ? void 0 : _a3.value) == null ? void 0 : _b.toLowerCase()) === e;
}
function Kn(t) {
  return t.hasAncestor((e) => {
    var _a3;
    if (e.type !== "css-rule") return false;
    let s = (_a3 = e.raws) == null ? void 0 : _a3.selector;
...
function Qn(t) {
  var _a3, _b;
  let { node: e } = t;
  return ((_a3 = e.groups[0]) == null ? void 0 : _a3.value) === "url" && e.groups.length === 2 && ((_b = t.findAncestor((s) => s.type === "css-atrule")) == null ? void 0 : _b.name) === "import";
}
function Xn(t) {
...
function es(t) {
  var _a3;
  return ((_a3 = t.raws) == null ? void 0 : _a3.params) && /^\(\s*\)$/u.test(t.raws.params);
}
function Mt(t) {
...
function ai(t) {
  var _a3, _b;
  return ((_a3 = t.value) == null ? void 0 : _a3.type) === "value-root" && ((_b = t.value.group) == null ? void 0 : _b.type) === "value-value" && t.prop.toLowerCase() === "composes";
}
function ui(t) {
  var _a3, _b, _c2;
  return ((_c2 = (_b = (_a3 = t.value) == null ? void 0 : _a3.group) == null ? void 0 : _b.group) == null ? void 0 : _c2.type) === "value-paren_group" && t.value.group.group.open !== null && t.value.group.group.close !== null;
}
function Z(t) {
  var _a3;
  return ((_a3 = t == null ? void 0 : t.raws) == null ? void 0 : _a3.before) === "";
}
function Bt(t) {
  var _a3, _b;
  return t.type === "value-comma_group" && ((_b = (_a3 = t.groups) == null ? void 0 : _a3[1]) == null ? void 0 : _b.type) === "value-colon";
}
function Zr(t) {
  var _a3;
  return t.type === "value-paren_group" && ((_a3 = t.groups) == null ? void 0 : _a3[0]) && Bt(t.groups[0]);
}
function ts(t, e) {
  var _a3, _b;
  ...
  let r = t.grandparent;
  return !Zr(s) && !(r && Zr(r)) ? false : !!(((_b = (_a3 = t.findAncestor((i) => i.type === "css-decl")) == null ? void 0 : _a3.prop) == null ? void 0 : _b.startsWith("$")) || Zr(r) || r.type === "value-func");
}
function Ze(t) {
...
function pi(t, e) {
  var _a3, _b;
  if (((_a3 = t.open) == null ? void 0 : _a3.value) !== "(" || ((_b = t.close) == null ? void 0 : _b.value) !== ")" || t.groups.some((s) => s.type !== "value-comma_group")) return false;
...
function rt(t) {
  var _a3, _b;
  return t.type === "value-paren_group" && ((_a3 = t.open) == null ? void 0 : _a3.value) === "(" && ((_b = t.close) == null ? void 0 : _b.value) === ")";
}
function hc(t, e, s) {
  var _a3;
    ...
    if (!(!(Lt(v) || Lt(y)) && !qe(t, "calc") && !ne && (ve(v) && !W || ve(y) && !A || J(v) && !W || J(y) && !A || xe(v) || xe(y)) && (Z(v) || q && (!m || m && Dt(m)))) && !((e.parser === "scss" || e.parser === "less") && q && y.value === "-" && rt(v) && R(y) === P(v.open) && v.open.value === "(")) {
      ...
      if (!(o && (o === "font" || o.startsWith("--")) && (ve(v) && Z(v) && hi(y) || ve(y) && Z(y) && hi(m)))) {
        ...
        if ((v == null ? void 0 : v.value) !== "..." && !(tt(y) && tt(v) && R(y) === P(v))) {
          ...
          if (!(((_a3 = y.value) == null ? void 0 : _a3.endsWith("#")) && v.value === "{" && rt(v.group)) && !(Ze(v) && !O)) {
...
function gi(t, e) {
  let s = e.singleQuote ? "'" : '"', r = "", n = t.match(new RegExp("^(?<value>.+?)\\s+(?<flag>[a-zA-Z])$", "u"));
  return n && ({ value: t, flag: r } = n.groups), (t.includes('"') || t.includes("'") ? t : s + t + s) + (r ? ` ${r}` : "");
}
function _e(t) {
  return E(0, t, wc, (e, s, r, n, i) => !r && n && (i != null ? i : i = "", i = i.toLowerCase(), !i || i === "n" || Wt.has(i)) ? ns(n) + (i ? ss(i) : "") : e);
}
function ns(t) {
...
function bi(t, e, s) {
  ...
  let o = t.map(({ node: g, isLast: b, index: d }) => {
    var _a3;
    let p = i[d];
    Bt(g) && g.type === "value-comma_group" && g.groups && g.groups[0].type !== "value-paren_group" && ((_a3 = g.groups[2]) == null ? void 0 : _a3.type) === "value-paren_group" && ue(p) === oe && ue(p.contents) === ie && ue(p.contents.contents) === ae && (p = D(le(p)));
    let m = [p, b ? kc(t, e) : ","];
...
function Cc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case "css-rule":
      return [s("selector"), r.important ? " !important" : "", r.nodes ? [((_a3 = r.selector) == null ? void 0 : _a3.type) === "selector-unknown" && Le(r.selector.value) ? C : r.selector ? " " : "", "{", r.nodes.length > 0 ? L([T, De(t, e, s)]) : "", T, "}", Zn(r) ? ";" : ""] : ";"];
    case "css-decl": {
    ...
    case "selector-attribute":
      return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), (_d = r.operator) != null ? _d : "", r.value ? gi(V(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
    ...
    case "selector-unknown": {
      if ((_e2 = t.findAncestor((u) => u.type === "css-rule")) == null ? void 0 : _e2.isSCSSNesterProperty) return _e(V(Ie(r.value), e));
      let i = t.parent;
      if ((_f = i.raws) == null ? void 0 : _f.selector) {
...
function By(t, e) {
  ...
  for (let a = 0; a < s.length; ++a) {
    ...
    if (e.parser === "scss" && l.type === "number" && l.unit === ".." && l.value.endsWith(".") && (l.value = l.value.slice(0, -1), l.unit = "..."), l.type === "func" && l.value === "selector" && (l.group.groups = [se(Gr(t).text.slice(l.group.open.sourceIndex + 1, l.group.close.sourceIndex))]), l.type === "func" && l.value === "url") {
      let f = (_b = (_a3 = l.group) == null ? void 0 : _a3.groups) != null ? _b : [], h = [];
...
function Yr(t) {
  return t.type === "paren_group" && !t.open && !t.close && t.groups.length === 1 || t.type === "comma_group" && t.groups.length === 1 ? Yr(t.groups[0]) : t.type === "paren_group" || t.type === "comma_group" ? __spreadProps(__spreadValues({}, t), { groups: t.groups.map(Yr) }) : t;
}
function fl(t, e) {
...
function gl(t, e) {
  ...
  if (Se(t)) {
    ...
    if (!t.type) return t;
    if ((_a3 = t.raws) != null ? _a3 : t.raws = {}, t.type === "css-decl" && typeof t.prop == "string" && t.prop.startsWith("--") && typeof t.value == "string" && t.value.startsWith("{")) {
      let i;
      if (t.value.trimEnd().endsWith("}")) {
        ...
        let f;
        try {
          f = l(a, __spreadValues({}, e));
        } catch (e2) {
        }
        ((_b = f == null ? void 0 : f.nodes) == null ? void 0 : _b.length) === 1 && f.nodes[0].type === "css-rule" && (i = f.nodes[0].nodes);
      }
      return i ? t.value = { type: "css-rule", nodes: i } : t.value = { type: "value-unknown", value: t.raws.value.raw }, t;
    }
    let s = "";
    typeof t.selector == "string" && (s = t.raws.selector ? (_c2 = t.raws.selector.scss) != null ? _c2 : t.raws.selector.raw : t.selector, t.raws.between && t.raws.between.trim().length > 0 && (s += t.raws.between), t.raws.selector = s);
    let r = "";
    typeof t.value == "string" && (r = t.raws.value ? (_d = t.raws.value.scss) != null ? _d : t.raws.value.raw : t.value, t.raws.value = r.trim());
    let n = "";
    if (typeof t.params == "string" && (n = t.raws.params ? (_e2 = t.raws.params.scss) != null ? _e2 : t.raws.params.raw : t.params, t.raws.afterName && t.raws.afterName.trim().length > 0 && (n = t.raws.afterName + n), t.raws.between && t.raws.between.trim().length > 0 && (n = n + t.raws.between), n = n.trim(), t.raws.params = n), s.trim().length > 0) return s.startsWith("@") && s.endsWith(":") ? t : t.mixin ? (t.selector = de(s, e), t) : (hl(t, e) && (t.isSCSSNesterProperty = true), t.selector = se(s), t);
    if (r.trim().length > 0) {
      let i = r.match(Gy);
    ...
    if (e.parser === "less" && t.type === "css-decl" && r.startsWith("extend(") && (t.extend || (t.extend = t.raws.between === ":"), t.extend && !t.selector && (delete t.value, t.selector = se(r.slice(7, -1)))), t.type === "css-atrule") {
      ...
      if (e.parser === "less") {
        ...
        if (!["page", "nest", "keyframes"].includes(t.name) && ((_f = t.params) == null ? void 0 : _f[0]) === ":") {
          t.variable = true;
...
function Js(t, e, s) {
  ...
  return s.originalText = e, i = gl(te(i, "css-"), s), Xr(i, e), r && (i.frontMatter = __spreadProps(__spreadValues({}, r), { type: "front-matter", source: { startOffset: r.start.index, endOffset: r.end.index } })), i;
}
function wl(t, e = {}) {
...
var Vy = __spreadProps(__spreadValues({}, Zs), { parse: wl });
var zy = __spreadProps(__spreadValues({}, Zs), { parse: vl });
var jy = __spreadProps(__spreadValues({}, Zs), { parse: xl });
var Hy = { postcss: Ei };
export {
  _l as default,
  Si as languages,
