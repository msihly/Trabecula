...
var Oe = (e5, t) => {
  for (var r in t) Un(e5, r, { get: t[r], enumerable: true });
};
var Bn = {};
Oe(Bn, { languages: () => Ln, parsers: () => yr, printers: () => Ai });
var Jt = (e5, t) => (r, s, ...n) => {
  var _a5;
  return r | 1 && s == null ? void 0 : ((_a5 = t.call(s)) != null ? _a5 : s[e5]).apply(s, n);
};
var _a;
var Mn = (_a = String.prototype.replaceAll) != null ? _a : function(e5, t) {
  return e5.global ? this.replace(e5, t) : this.split(e5).join(t);
};
var zn = Jt("replaceAll", function() {
...
var se = Wn;
var jn = (e5) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e5);
function Qn(e5) {
  ...
  function n(i) {
    switch (se(i)) {
      case It:
        return t(i.map(s));
      case wt:
        return t(__spreadProps(__spreadValues({}, i), { parts: i.parts.map(s) }));
      case Tt:
        return t(__spreadProps(__spreadValues({}, i), { breakContents: s(i.breakContents), flatContents: s(i.flatContents) }));
      case vt: {
        let { expandedStates: a, contents: o } = i;
        return a ? (a = a.map(s), o = a[0]) : o = s(o), t(__spreadProps(__spreadValues({}, i), { contents: o, expandedStates: a }));
      }
      case Et:
      case kt:
      case Zt:
      case re:
      case te:
        return t(__spreadProps(__spreadValues({}, i), { contents: s(i.contents) }));
      case Ot:
      case $t:
      case Xt:
      case ee:
...
var Xn = { type: Q, hard: true };
var ut = [Xn, Re];
var Zn = { type: Q, hard: true, literal: true };
var Lr = [Zn, Re];
var Ir = Object.freeze({ character: "'", codePoint: 39 });
var Br = Object.freeze({ character: '"', codePoint: 34 });
var ts = Object.freeze({ preferred: Ir, alternate: Br });
var es = Object.freeze({ preferred: Br, alternate: Ir });
function rs(e5, t) {
  let { preferred: r, alternate: s } = t === true || t === "'" ? ts : es, { length: n } = e5, i = 0, a = 0;
  for (let o = 0; o < n; o++) {
...
var He = (_a2 = class {
  ...
  split(t, r = false) {
    let s = `[${Fe([...__privateGet(this, _t)].join(""))}]+`, n = new RegExp(r ? `(${s})` : s, "u");
    return t.split(n);
  }
...
function as(e5) {
  ...
  if (!(s && !(s.value.type === "TextNode" && (s.value.chars === "" || s.value.chars === "css")))) return (n) => __async(null, null, function* () {
    let i = t.chars;
    return i.trim() ? yield n(i, { parser: "css" }) : "";
  });
}
var Hr = as;
var Rt = null;
function qt(e5) {
  ...
  return Rt = qt.prototype = e5 != null ? e5 : /* @__PURE__ */ Object.create(null), new qt();
}
var os = 10;
...
var us = (function() {
  var e5 = function(X, b, S, y) {
    ...
    }, L, _e2, lt, q, Ci, Le, yt = {}, jt, j, Cr, Qt; ; ) {
...
Expecting ` + Qt.join(", ") + ", got '" + (this.terminals_[L] || L) + "'" : De = "Parse error on line " + (Z + 1) + ": Unexpected " + (L == Pr ? "end of input" : "'" + (this.terminals_[L] || L) + "'"), this.parseError(De, { text: x.match, token: this.terminals_[L] || L, line: x.yylineno, loc: Ce, expected: Qt });
      ...
      switch (q[0]) {
        case 1:
          y.push(L), w.push(x.yytext), l.push(x.yylloc), y.push(q[1]), L = null, _e2 ? (L = _e2, _e2 = null) : (Lt = x.yyleng, u = x.yytext, Z = x.yylineno, Ce = x.yylloc, Ar > 0 && Ar--);
          break;
        case 2:
...
G.prototype.Program = function(e5) {
  ...
  for (var s = e5.body, n = 0, i = s.length; n < i; n++) {
    ...
    if (o) {
      ...
      o.close && ht(s, n, true), o.open && et(s, n, true), t && g && (ht(s, n), et(s, n) && a.type === "PartialStatement" && (a.indent = /([ \t]+$)/.exec(s[n - 1].original)[1])), t && f && (ht((a.program || a.inverse).body), et(s, n)), t && p && (ht(s, n), et((a.inverse || a.program).body));
    }
  }
  return e5;
};
G.prototype.BlockStatement = G.prototype.DecoratorBlock = G.prototype.PartialBlockStatement = function(e5) {
  ...
  if (e5.openStrip.close && ht(t.body, null, true), r) {
    var a = e5.inverseStrip;
    a.open && et(t.body, null, true), a.close && ht(s.body, null, true), e5.closeStrip.open && et(n.body, null, true), !this.options.ignoreStandalone && Ke(t.body) && We(s.body) && (et(t.body), ht(s.body));
...
function he(e5, t) {
  ...
  var i;
  typeof ((r = t == null ? void 0 : t.syntax) === null || r === void 0 ? void 0 : r.square) == "function" ? i = t.syntax.square : ((s = t == null ? void 0 : t.syntax) === null || s === void 0 ? void 0 : s.square) === "node" ? i = Es : i = "string";
  var a;
  return typeof ((n = t == null ? void 0 : t.syntax) === null || n === void 0 ? void 0 : n.hash) == "function" ? a = t.syntax.hash : a = vs, Vt.yy.syntax = { square: i, hash: a }, Vt.parse(e5);
}
function Es(e5, t) {
...
var _s = false;
var Ls = /["\x26\xa0]/u;
var vo = new RegExp(Ls.source, "gu");
var Ds = /[&<>\xa0]/u;
var wo = new RegExp(Ds.source, "gu");
...
function Os(e5) {
  var _a5;
  return de.has(e5.toLowerCase()) && ((_a5 = e5[0]) == null ? void 0 : _a5.toLowerCase()) === e5[0];
}
function Yt(e5) {
...
}, _t3 = new WeakMap(), _e = new WeakMap(), _a4);
var J = class {
  constructor(t, r, s = null) {
...
var Rs = ln(((e5) => e5.when("HbsPosition", "HbsPosition", (({ hbsPos: t }, { hbsPos: r }) => t.column === r.column && t.line === r.line)).when("CharPosition", "CharPosition", (({ charPos: t }, { charPos: r }) => t === r)).when("CharPosition", "HbsPosition", (({ offset: t }, r) => {
  var _a5;
  return t === ((_a5 = r.toCharPos()) == null ? void 0 : _a5.offset);
})).when("HbsPosition", "CharPosition", ((t, { offset: r }) => {
  var _a5;
  return ((_a5 = t.toCharPos()) == null ? void 0 : _a5.offset) === r;
})).when("MATCH_ANY", "MATCH_ANY", (() => false))));
var pt = class e4 {
  static from(t, r = {}) {
    var _a5;
    return new e4(t, (_a5 = r.meta) == null ? void 0 : _a5.moduleName);
  }
...
var Us = { mustache: function(e5, t = [], r = Ht([]), s = false, n, i) {
  ...
  let h, f = null;
  return h = s.type === "Template" ? d.blockItself({ params: fn(s.blockParams), body: s.body, loc: s.loc }) : s, (n == null ? void 0 : n.type) === "Template" ? (n.blockParams.length, f = d.blockItself({ params: [], body: n.body, loc: n.loc })) : f = n, d.block({ path: rt(e5), params: t || [], hash: r || Ht([]), defaultBlock: h, elseBlock: f, loc: v(i || null), openStrip: a, inverseStrip: o, closeStrip: c });
  ...
  let g = i == null ? void 0 : i.map(((T) => typeof T == "string" ? rn(T) : T)), E = null;
  ...
  path({ head: e5, tail: t, loc: r }) {
    return (function({ head: s, tail: n, loc: i }) {
      ...
      return Object.defineProperty(a, "parts", { enumerable: false, get() {
        ...
        var _a5;
        let c = [...o];
        c[0] === "this" || ((_a5 = c[0]) == null ? void 0 : _a5.startsWith("@")) || (this.head.type === "ThisHead" ? c.unshift("this") : this.head.type === "AtHead" && (c[0] = `@${c[0]}`)), this.original = c.join(".");
...
var ur = class extends cr {
  parse(t, r) {
    ...
    return (_a5 = this.pendingError) == null ? void 0 : _a5.eof(n.loc.getEnd()), n;
  }
  Program(t, r) {
    t.loc;
  ...
  parseProgram(t, r) {
    ...
    if (t !== s) {
      if ((s == null ? void 0 : s.type) === "ElementNode") throw k(`Unclosed element \`${s.tag}\``, s.loc);
      t.type;
    }
    return t;
  }
  BlockStatement(t) {
    ...
    if ((_a5 = t.program.blockParams) == null ? void 0 : _a5.length) {
  ...
  MustacheStatement(t) {
    var _a5;
    (_a5 = this.pendingError) == null ? void 0 : _a5.mustache(this.source.spanFor(t.loc));
...
function an(e5, t, r) {
  if (!t.program.loc) {
    ...
    if (n && i) t.program.loc = __spreadProps(__spreadValues({}, n.loc), { end: i.loc.end });
    else {
...
function mn(e5, t = {}) {
  ...
  typeof e5 == "string" ? (r = new pt(e5, (_a5 = t.meta) == null ? void 0 : _a5.moduleName), s = i === "codemod" ? he(e5, t.parseOptions) : Je(e5, t.parseOptions)) : e5 instanceof pt ? (r = e5, s = i === "codemod" ? he(e5.source, t.parseOptions) : Je(e5.source, t.parseOptions)) : (r = new pt("", (_b = t.meta) == null ? void 0 : _b.moduleName), s = e5), i === "codemod" && (n = new pr());
  let a = A.forCharPositions(r, 0, r.source.length);
  s.loc = { source: "(program)", start: a.startPosition, end: a.endPosition };
  let o = new hr(r, n, i).parse(s, (_c = t.locals) != null ? _c : []);
  if ((_d = t.plugins) == null ? void 0 : _d.ast) for (let c of t.plugins.ast) Hs(o, c(ze({}, t, { syntax: Ms }, { plugins: void 0 })).visitor);
  return o;
}
var zs = { resolution: () => pe.GetStrictKeyword, serialize: () => "Strict", isAngleBracket: false };
var To = __spreadProps(__spreadValues({}, zs), { isAngleBracket: true });
var Ys = Ur(be);
var dn = Ys;
var mt = (e5) => e5.loc.start.offset;
...
var xn = 2;
function js(e5, t, r) {
  var _a5, _b, _c, _d, _e2, _f, _g, _h, _i;
  let { node: s } = e5;
  switch (s.type) {
    case "Block":
    case "Program":
    ...
    case "ElementNode": {
      let n = t.htmlWhitespaceSensitivity !== "ignore", i = [!n && ((_a5 = e5.previous) == null ? void 0 : _a5.type) === "ElementNode" ? H : "", I([Js(e5, r)])];
      if (dr(s)) return [i];
    ...
    case "TextNode": {
      ...
      if (a) {
        if (a === "class") {
          let D = n.trim().split(/\s+/u).join(" "), B = false, O = false;
          return e5.parent.type === "ConcatStatement" && (((_b = e5.previous) == null ? void 0 : _b.type) === "MustacheStatement" && /^\s/u.test(n) && (B = true), ((_c = e5.next) == null ? void 0 : _c.type) === "MustacheStatement" && /\s$/u.test(n) && D !== "" && (O = true)), [B ? N : "", D, O ? N : ""];
        }
        return ie(n);
      }
      ...
      o && f ? (p = Math.min(f, xn), g = 0) : ((((_d = e5.next) == null ? void 0 : _d.type) === "BlockStatement" || ((_e2 = e5.next) == null ? void 0 : _e2.type) === "ElementNode") && (g = Math.max(g, 1)), (((_f = e5.previous) == null ? void 0 : _f.type) === "BlockStatement" || ((_g = e5.previous) == null ? void 0 : _g.type) === "ElementNode") && (p = Math.max(p, 1)));
      let E = "", T = "";
      return g === 0 && ((_h = e5.next) == null ? void 0 : _h.type) === "MustacheStatement" && (T = " "), p === 0 && ((_i = e5.previous) == null ? void 0 : _i.type) === "MustacheStatement" && (E = " "), c && (p = 0, E = ""), h && (g = 0, T = ""), R.hasLeadingWhitespace(n) && (n = E + R.trimStart(n)), R.hasTrailingWhitespace(n) && (n = R.trimEnd(n) + T), [...Kt(p), qe(wn(n)), ...Kt(g)];
    }
...
function ke(e5) {
  var _a5;
  let t = e5.trusting ? "{{{" : "{{", r = ((_a5 = e5.strip) == null ? void 0 : _a5.open) ? "~" : "";
  return [t, r];
}
function Ee(e5) {
  var _a5;
  let t = e5.trusting ? "}}}" : "}}";
  return [((_a5 = e5.strip) == null ? void 0 : _a5.close) ? "~" : "", t];
}
function Xs(e5) {
...
function ve(e5, t) {
  var _a5;
  let { node: r } = e5, s = [];
  return r.params.length > 0 && s.push(...e5.map(t, "params")), ((_a5 = r.hash) == null ? void 0 : _a5.pairs.length) > 0 && s.push(t("hash")), s.length === 0 ? "" : ct(N, s);
}
function br(e5) {
...
var fi = (e5, t) => t === 0 && e5.startsWith("@") ? false : t !== 0 && pi.has(e5) || /\s/u.test(e5) || /^\d/u.test(e5) || Array.prototype.some.call(e5, (r) => hi.has(r));
function mi(e5) {
  return e5.tail.length === 0 && e5.original.includes("/") ? e5.original : [e5.head.original, ...e5.tail].map((r, s) => fi(r, s) ? `[${r}]` : r).join(".");
}
var di = { features: { experimental_frontMatterSupport: { massageAstNode: true, embed: true, print: true } }, print: js, massageAstNode: Fr, hasPrettierIgnore: yn, getVisitorKeys: dn, embed: Hr };
var _n = di;
...
var Dn = gi;
var On = /* @__PURE__ */ Symbol.for("PRETTIER_IS_FRONT_MATTER");
var Wt = 3;
function bi(e5) {
  let t = e5.slice(0, Wt);
  if (t !== "---" && t !== "+++") return;
...
function Si(e5) {
  var _a5;
  let t = (_a5 = e5.children) != null ? _a5 : e5.body;
...
var Ei = () => ({ name: "glimmerPrettierParsePlugin", visitor: { All(e5) {
  ki(e5), Si(e5);
} } });
var vi = { mode: "codemod", plugins: { ast: [Ei] } };
function wi(e5) {
  ...
  if (t) {
    let n = __spreadProps(__spreadValues({}, t), { type: "FrontMatter", loc: { start: __spreadProps(__spreadValues({}, t.start), { offset: t.start.index }), end: __spreadProps(__spreadValues({}, t.end), { offset: t.end.index }) } });
    s.body.unshift(n);
  }
  return s;
}
