...
var me = (e2, t) => (n, i, ...r) => {
  var _a2;
  return n | 1 && i == null ? void 0 : ((_a2 = t.call(i)) != null ? _a2 : i[e2]).apply(i, r);
};
var _a;
var lt = (_a = String.prototype.replaceAll) != null ? _a : function(e2, t) {
...
function w(e2) {
  ...
  return P = w.prototype = e2 != null ? e2 : /* @__PURE__ */ Object.create(null), new w();
}
var yt = 10;
...
function Ct(e2) {
  var _a2;
  let { node: t } = e2;
  return (_a2 = t == null ? void 0 : t.comments) == null ? void 0 : _a2.some((n) => n.value.trim() === "prettier-ignore");
}
...
var Q = class e extends Error {
  constructor(t, ...n) {
    ...
    super(t), this.name = "GraphQLError", this.path = T != null ? T : void 0, this.originalError = d != null ? d : void 0, this.nodes = Qe(Array.isArray(a) ? a : a ? [a] : void 0);
    let O = Qe((i = this.nodes) === null || i === void 0 ? void 0 : i.map((N) => N.loc).filter((N) => N != null));
    this.source = u != null ? u : O == null || (r = O[0]) === null || r === void 0 ? void 0 : r.source, this.positions = p != null ? p : O == null ? void 0 : O.map((N) => N.start), this.locations = p && u ? p.map((N) => M(u, N)) : O == null ? void 0 : O.map((N) => M(N.source, N.start));
    let re = Xe(d == null ? void 0 : d.extensions) ? d == null ? void 0 : d.extensions : void 0;
    this.extensions = (s = D != null ? D : re) !== null && s !== void 0 ? s : /* @__PURE__ */ Object.create(null), Object.defineProperties(this, { message: { writable: true, enumerable: true }, name: { enumerable: false }, nodes: { enumerable: false }, source: { enumerable: false }, positions: { enumerable: false }, originalError: { enumerable: false } }), d != null && d.stack ? Object.defineProperty(this, "stack", { value: d.stack, writable: true, configurable: true }) : Error.captureStackTrace ? Error.captureStackTrace(this, e) : Object.defineProperty(this, "stack", { value: Error().stack, writable: true, configurable: true });
  }
  get [Symbol.toStringTag]() {
    return "GraphQLError";
  }
...
var fe = class {
  constructor(t, n = {}) {
    let _a2 = n, { lexer: i } = _a2, r = __objRest(_a2, ["lexer"]);
    if (i) this._lexer = i;
    else {
