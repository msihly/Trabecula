...
var Icon = (_a) => {
  ...
  }) : name ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_material13.Icon, __spreadProps(__spreadValues({}, props), { style: __spreadProps(__spreadValues({}, style), { color, fontSize: size }), children: Fmt.pascalToSnake(name) })) : "" }));
};
