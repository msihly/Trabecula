...
export declare const Detail: ({ emptyValueText, label, labelProps, overflowX, overflowY, row, tooltip, value, valueProps, withTooltip, ...props }: DetailProps) => import("react").JSX.Element;
