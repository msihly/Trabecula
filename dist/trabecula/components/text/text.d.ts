...
export declare const Text: ({ children, className, color, component, fontSize, fontWeight, overflow, preset, tooltip, tooltipProps, ...props }: TextProps) => import("react/jsx-runtime").JSX.Element;
