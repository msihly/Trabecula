...
import { a as LogicalOp } from '../math-CE6iMN_S.js';
...
declare const FilterHeader: react.ForwardRefExoticComponent<FilterHeaderProps & react.RefAttributes<HTMLDivElement>>;
...
declare const HeaderContent: ({ children, leftNode, rightNode }: HeaderContentProps) => react_jsx_runtime.JSX.Element;
