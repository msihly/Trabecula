...
var Wt = (e, t) => (r, n, ...s) => {
  var _a5;
  return r | 1 && n == null ? void 0 : ((_a5 = t.call(n)) != null ? _a5 : n[e]).apply(n, s);
};
var _a;
var ba = (_a = String.prototype.replaceAll) != null ? _a : function(e, t) {
...
var oi = Va;
function $a(e, t) {
  Le(new RegExp(`^(?<quote>["']).*\\k<quote>$`, "su").test(e));
...
function w(e) {
  ...
  let t = (_b = (_a5 = e.range) == null ? void 0 : _a5[0]) != null ? _b : e.start, r = (_e3 = (_d = (_c2 = e.declaration) == null ? void 0 : _c2.decorators) != null ? _d : e.decorators) == null ? void 0 : _e3[0];
  return r ? Math.min(w(r), t) : t;
}
function I(e) {
  var _a5, _b;
  return (_b = (_a5 = e.range) == null ? void 0 : _a5[1]) != null ? _b : e.end;
}
function bt(e, t) {
  let r = w(e);
  return ui(r) && r === w(t);
...
function fr(e) {
  ...
  return Dr = fr.prototype = e != null ? e : /* @__PURE__ */ Object.create(null), new fr();
}
var Qa = 10;
...
function tp(e) {
  var _a5, _b;
  return (_b = (_a5 = e.extra) == null ? void 0 : _a5.raw) != null ? _b : e.raw;
}
var pe = tp;
...
function mi(e) {
  ...
  return e.expressions ? e.expressions[0] : (_f = (_e3 = (_d = (_c2 = (_b = (_a5 = e.left) != null ? _a5 : e.test) != null ? _b : e.callee) != null ? _c2 : e.object) != null ? _d : e.tag) != null ? _e3 : e.argument) != null ? _f : e.expression;
}
function Rr(e) {
...
function Re(e, t = 2) {
  ...
  let r = (n) => Re(n, t - 1);
  if (Xn(e)) return ot((_a5 = e.pattern) != null ? _a5 : e.regex.pattern) <= 5;
...
function Ti(e) {
  ...
  let t = K(e);
  return ((_a5 = N(0, t, -1)) == null ? void 0 : _a5.type) === "RestElement";
}
...
function Si(e, t, r) {
  ...
  e.type === "JSXAttribute" && e.name.name === "css" && e.value.type === "JSXExpressionContainer" && e.value.expression.type === "TemplateLiteral" && Kt(t.value.expression), e.type === "JSXAttribute" && ((_a5 = e.value) == null ? void 0 : _a5.type) === "Literal" && /["']|&quot;|&apos;/u.test(e.value.value) && (t.value.value = W(0, e.value.value, /["']|&quot;|&apos;/gu, '"'));
...
function Kn(e, t) {
  var _a5;
  ((_a5 = e.comments) != null ? _a5 : e.comments = []).push(t), t.printed = false, t.nodeDescription = hp(e);
}
function te(e, t) {
...
function ns({ comment: e, enclosingNode: t, ast: r, isLastComment: n }) {
  var _a5;
  return ((_a5 = r == null ? void 0 : r.body) == null ? void 0 : _a5.length) === 0 ? (n ? we(r, e) : te(r, e), true) : (t == null ? void 0 : t.type) === "Program" && t.body.length === 0 && !R(t.directives) ? (n ? we(t, e) : te(t, e), true) : false;
}
  ...
  function s(i) {
    switch (We(i)) {
      case Be:
        return t(i.map(n));
      case Me:
        return t(__spreadProps(__spreadValues({}, i), { parts: i.parts.map(n) }));
      case be:
        return t(__spreadProps(__spreadValues({}, i), { breakContents: n(i.breakContents), flatContents: n(i.flatContents) }));
      case Fe: {
        let { expandedStates: o, contents: u } = i;
        return o ? (o = o.map(n), u = o[0]) : u = n(u), t(__spreadProps(__spreadValues({}, i), { contents: u, expandedStates: o }));
      }
      case Xe:
      case He:
      case Ve:
      case Pe:
      case $e:
        return t(__spreadProps(__spreadValues({}, i), { contents: n(i.contents) }));
      case Ye:
      case tt:
      case rt:
      case Ge:
...
function Ar(e, t) {
  return e.type === Pe ? __spreadProps(__spreadValues({}, e), { contents: t(e.contents) }) : t(e);
}
function Vi(e) {
  let t = true;
  return Vr(e, (r) => {
...
function eo(e, t, r) {
  ...
  return F(), __spreadProps(__spreadValues({}, e), { value: s, length: i, queue: n });
  function p(d) {
...
function to(e, t, r) {
  if (!t) return e;
  if (t.type === "root") return __spreadProps(__spreadValues({}, e), { root: e });
...
function Zr(e, t, r, n, s, i) {
  ...
  for (; r >= 0; ) {
    ...
    switch (F) {
      ...
      case Be:
      case Me: {
        let C = F === Be ? D : D.parts, d = (_a5 = D[cs]) != null ? _a5 : 0;
...
`, s) : S;
      ...
      case Fe:
        ...
        break;
      case Me: {
        let j = n - i, U = (_a5 = S[cs]) != null ? _a5 : 0, { parts: fe } = S, Y = fe.length - U;
        if (Y === 0) break;
        ...
        let it = fe[U + 2], Bt = { indent: h, mode: g, doc: __spreadProps(__spreadValues({}, S), { [cs]: U + 2 }) }, Pr = Zr({ indent: h, mode: ct, doc: [z, ee, it] }, [], j, c.length > 0, r, true);
...
`) ? so(F, D) : p;
    ...
    if (!B) {
      let h = ls(d, __spreadProps(__spreadValues({}, t), { printWidth: Number.POSITIVE_INFINITY })).formatted;
      h.includes(`
`) ? B = true : d = h;
    }
...
function io(e, t, r) {
  ...
  return o && (ue(t.originalText, I((_a5 = s.typeArguments) != null ? _a5 : s.tag), w(o)) ? i = f : i = " "), pt(n.label && __spreadValues({ tagged: true }, n.label), [r("tag"), r("typeArguments"), i, je, n]);
}
function bc(e, t, r) {
  ...
  if (s.length > 1 || s.some((i) => i.length > 0)) {
    ...
    let o = i.map((D) => "${" + ls(D, __spreadProps(__spreadValues({}, t), { printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })).formatted + "}"), u = [{ hasLineBreak: false, cells: [] }];
...
function ao(e, t, r) {
  return __async(this, null, function* () {
    ...
    let i = yield e(s, { parser: "scss" }), o = zt(r, t), u = Lc(i, o);
...
`), C = F.length, d = i[u], b = C > 2 && F[0].trim() === "" && F[1].trim() === "", B = C > 2 && F[C - 1].trim() === "" && F[C - 2].trim() === "", O = F.every((g) => /^\s*(?:#[^\n\r]*)?$/u.test(g));
      ...
      let h = null;
      O ? h = Mc(F) : h = yield e(D, { parser: "graphql" }), h ? (h = tn(h, false), !c && b && o.push(""), o.push(h), !y && B && o.push("")) : !c && !y && b && o.push(""), d && o.push(d);
    }
    return ["`", m([E, L(E, o)]), E, "`"];
  });
}
...
function mo(e, t, r, n, s) {
  return __async(this, null, function* () {
    let { node: i } = n, o = Es;
    Es = Es + 1 >>> 0;
    let u = (O) => `PRETTIER_HTML_PLACEHOLDER_${O}_${o}_IN_JS`, p = i.quasis.map((O, h, g) => h === g.length - 1 ? O.value.cooked : O.value.cooked + u(h)).join(""), c = zt(n, r), y = new RegExp(u("(\\d+)"), "gu"), D = 0, F = yield t(p, { parser: e, __onHtmlRoot(O) {
      D = O.children.length;
    } }), C = ft(F, (O) => {
...
function Eo(e, t, r) {
  return __async(this, null, function* () {
    ...
    let u = tn(yield e(s, { parser: "markdown", __inJsTemplate: true }), true);
...
function Rc(e) {
  return (...t) => __async(null, null, function* () {
    let r = yield e(...t);
    return r && pt(__spreadValues({ embed: true }, r.label), r);
  });
}
...
function Bo(e) {
  var _a5;
  let r = (_a5 = e.match(go)) == null ? void 0 : _a5[0];
...
function Lo(e) {
  let { shebang: t, text: r, pragmas: n, comments: s } = Xc(e), i = Bo(r), o = Po({ pragmas: __spreadValues({ [ko]: "" }, n), comments: s.trimStart() });
  return (t ? `${t}
` : "") + o + (i.startsWith(`
`) ? `
` : `
...
function ds(e, t) {
  ...
  if (r.type === "Identifier") {
    if (((_a5 = r.extra) == null ? void 0 : _a5.parenthesized) && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/u.test(r.name) || n === "left" && (r.name === "async" && !s.await || r.name === "let") && s.type === "ForOfStatement") return true;
    if (r.name === "let") {
  ...
  switch (r.type) {
    ...
    case "FunctionTypeAnnotation": {
      ...
      return i.type === "UnionTypeAnnotation" || i.type === "IntersectionTypeAnnotation" || i.type === "ArrayTypeAnnotation" || n === "objectType" && (i.type === "IndexedAccessType" || i.type === "OptionalIndexedAccessType") || n === "checkType" && s.type === "ConditionalTypeAnnotation" || n === "extendsType" && s.type === "ConditionalTypeAnnotation" && ((_f = r.returnType) == null ? void 0 : _f.type) === "InferTypeAnnotation" && ((_g = r.returnType) == null ? void 0 : _g.typeParameter.bound) || i.type === "NullableTypeAnnotation" || s.type === "FunctionTypeParam" && s.name === null && K(r).some((o) => {
        var _a6;
        return ((_a6 = o.typeAnnotation) == null ? void 0 : _a6.type) === "NullableTypeAnnotation";
      });
    }
...
function il(e, t) {
  ...
  if ((_a5 = s.isBlockComment) == null ? void 0 : _a5.call(s, r)) {
...
function ol(e, t, r) {
  var _a5;
  let n = e.node, s = As(e, t), { printer: i, originalText: o, locStart: u } = t, p = (_a5 = i.isBlockComment) == null ? void 0 : _a5.call(i, n);
...
function lt(e, t) {
  ...
  let r = ul(e);
  if (!r) return false;
  let n = (_a5 = e.typeParameters) == null ? void 0 : _a5.params;
  if (n) {
...
function on(e, t, r) {
  var _a5;
  let { node: n, parent: s, grandparent: i, key: o } = e, u = o !== "body" && (s.type === "IfStatement" || s.type === "WhileStatement" || s.type === "SwitchStatement" || s.type === "DoWhileStatement"), p = n.operator === "|>" && ((_a5 = e.root.extra) == null ? void 0 : _a5.__isUsingHackPipeline), c = Ts(e, t, r, false, u);
  if (u) return c;
  if (p) return l(c);
...
function Ts(e, t, r, n, s) {
  ...
  if (u) d = [F, Ee(t.originalText, p) ? m([A, r("right"), C]) : [" ", r("right"), C]];
    ...
    let g = F === "|>" && ((_a5 = e.root.extra) == null ? void 0 : _a5.__isUsingHackPipeline) ? e.call(() => Ts(e, t, r, true, s), "right") : r("right");
...
function tr(e, t, r) {
  ...
  if (p.length === 0) s.push(Al(e, t, i, o));
    ...
    let c = N(0, p, -1), y = (c == null ? void 0 : c.type) !== "RestElement" && !n.inexact, D = c === null, F = /* @__PURE__ */ Symbol("array"), C = !t.__inJestEach && p.length > 1 && p.every((B, O, h) => {
...
function hl(e, t, r) {
  ...
  if (e.length === 1) {
    let i = N(0, t, -1);
    if (((_a5 = i.label) == null ? void 0 : _a5.embed) && ((_b = i.label) == null ? void 0 : _b.hug) !== false) return true;
  }
  let s = N(0, e, -2);
...
function Ho(e, t, r) {
  var _a5;
  let n = r("object"), s = Ss(e, t, r), { node: i } = e, o = e.findAncestor((c) => !(J(c) || c.type === "TSNonNullExpression")), u = e.findAncestor((c) => !(c.type === "ChainExpression" || c.type === "TSNonNullExpression")), p = o.type === "BindExpression" || o.type === "AssignmentExpression" && o.left.type !== "Identifier" || Il(e) || i.computed || i.object.type === "Identifier" && i.property.type === "Identifier" && !J(u) || (u.type === "AssignmentExpression" || u.type === "VariableDeclarator") && (kl(i.object) || ((_a5 = n.label) == null ? void 0 : _a5.memberChain));
...
function Xo(e, t, r) {
  ...
  function d(_) {
    var _a5;
    let re = (_a5 = _[1][0]) == null ? void 0 : _a5.node.computed;
    if (_[0].length === 1) {
      let it = _[0][0].node;
...
function vt(e, t, r) {
  ...
  if (p || Ol(e) || wl(e) || It(n, e.parent)) {
    ...
    if ($t(e, () => {
      D.push(r());
    }), !(p && ((_a5 = D[0].label) == null ? void 0 : _a5.embed))) return [s ? "new " : "", $o(e, r), i, u, "(", L(", ", D), ")"];
  }
...
function Nl(e) {
  if (eu(e)) {
    ...
    return t.type === "ObjectPattern" && t.properties.length > 2 && t.properties.some((r) => {
      var _a5;
      return Oe(r) && (!r.shorthand || ((_a5 = r.value) == null ? void 0 : _a5.type) === "AssignmentPattern");
    });
  }
  return false;
}
...
function vl(e) {
  var _a5;
  if (Cr(e)) return (_a5 = e.typeParameters) == null ? void 0 : _a5.params;
}
function Rl(e) {
...
function Bs(e) {
  var _a5;
  return e.type === "VariableDeclarator" && ((_a5 = e.init) == null ? void 0 : _a5.type) === "ArrowFunctionExpression";
}
function Ko(e) {
  let t;
  switch (e.type) {
...
function tu(e, t, r, n = false) {
  ...
  if (M(s)) {
    if ((_a5 = vt(e, t, r).label) == null ? void 0 : _a5.memberChain) return false;
    let u = le(s);
...
function Wl(e) {
  var _a5, _b;
  return (_b = (_a5 = e.typeParameters) != null ? _a5 : e.typeArguments) == null ? void 0 : _b.params;
}
function Qo(e) {
  switch (e.type) {
    case "FunctionTypeAnnotation":
...
var _e2, _ws_instances, t_fn, _a3;
var ws = (_a3 = class {
  constructor(t) {
...
function tm(e, t, r) {
  ...
  if (((_a5 = n.attributes) == null ? void 0 : _a5.length) === 1 && V(n.attributes[0].value) && !n.attributes[0].value.value.includes(`
...
function Cu(e) {
  ...
  let t = (_a5 = e.declaration) == null ? void 0 : _a5.decorators;
  return R(t) && bt(e, t[0]);
}
...
function Fm(e, t, r) {
  var _a5, _b;
  return q(e) || se(e) || e.type === "ArrowFunctionExpression" || e.type === "DoExpression" || e.type === "BlockStatement" || H(e) || ((_a5 = t.label) == null ? void 0 : _a5.hug) !== false && (((_b = t.label) == null ? void 0 : _b.embed) || Wr(e, r.originalText));
}
...
var _a4;
var Am = (_a4 = Array.prototype.findLast) != null ? _a4 : function(e) {
...
function hm(e, t) {
  ...
  if (r.type === "ObjectTypeAnnotation") {
    ...
    for (let [s, { node: i, selector: o }] of n.entries()) e.call(() => {
      var _a5;
      return t({ node: i, next: (_a5 = n[s + 1]) == null ? void 0 : _a5.node, isLast: s === n.length - 1 });
    }, ...o);
  }
}
function he(e, t) {
...
function Sm({ node: e, next: t }, r) {
  ...
  if (!t.computed) {
    let n = (_a5 = t.key) == null ? void 0 : _a5.name;
...
function Im(e) {
  ...
  if (t.superClass) return e.parent.type === "AssignmentExpression" ? false : !((_a5 = t.superTypeArguments) != null ? _a5 : t.superTypeParameters) && J(t.superClass);
  let r = (_f = (_d = (_b = t.extends) == null ? void 0 : _b[0]) != null ? _d : (_c2 = t.mixins) == null ? void 0 : _c2[0]) != null ? _f : (_e3 = t.implements) == null ? void 0 : _e3[0];
...
function ir(e, t, r) {
  ...
  let d = !(p || ((_a5 = N(0, y, -1)) == null ? void 0 : _a5.type) === "RestElement"), b;
  if (C.length === 0) {
...
function Wm(e, t) {
  var _a5, _b;
  if ((_a5 = e.extra) == null ? void 0 : _a5.deprecatedAssertSyntax) return "assert";
...
function Hu(e, t, r, n) {
  ...
  switch (s.type) {
    ...
    case "File":
      return (_a5 = wu(e, t, r)) != null ? _a5 : r("program");
...
function tD(e, t) {
  var _a5;
  return e.rest || ((_a5 = N(0, t, -1)) == null ? void 0 : _a5.type) === "RestElement";
}
function rD(e, t) {
...
function nD(e) {
  var _a5;
  let { node: t, parent: r } = e;
  return t.type === "FunctionTypeAnnotation" && (Gr(r) || !((r.type === "ObjectTypeProperty" || r.type === "ObjectTypeInternalSlot") && !r.variance && !r.optional && bt(r, t) || r.type === "ObjectTypeCallProperty" || ((_a5 = e.getParentNode(2)) == null ? void 0 : _a5.type) === "DeclareFunction"));
}
function zu(e, t, r) {
  let { node: n } = e, s = ["hook"];
  n.id && s.push(" ", r("id"));
...
function Qu(e) {
  var _a5;
  let { node: t } = e;
  return t.type === "HookTypeAnnotation" && ((_a5 = e.getParentNode(2)) == null ? void 0 : _a5.type) === "DeclareHook";
}
function ea(e, t, r) {
...
function pa(e, t, r) {
  ...
  switch (n.type) {
    ...
    case "DeclareVariable":
      return [Q(e), (_a5 = n.kind) != null ? _a5 : "var", " ", r("id"), t.semi ? ";" : ""];
...
function mD(e, t, r, n) {
  var _a5;
  e.isRoot && ((_a5 = t.__onHtmlBindingRoot) == null ? void 0 : _a5.call(t, e.node, t));
