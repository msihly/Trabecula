...
b.readInt = function(e, t, i) {
  for (var s = this.options.ecmaVersion >= 12 && t === void 0, r = i && this.input.charCodeAt(this.pos) === 48, o = this.pos, u = 0, p = 0, h = 0, l = t != null ? t : 1 / 0; h < l; ++h, ++this.pos) {
...
var te = (e, t) => (i, s, ...r) => {
  var _a3;
  return i | 1 && s == null ? void 0 : ((_a3 = t.call(s)) != null ? _a3 : s[e]).apply(s, r);
};
var _a;
var ks = (_a = Array.prototype.findLast) != null ? _a : function(e) {
...
function M(e) {
  ...
  let t = (_b = (_a3 = e.range) == null ? void 0 : _a3[0]) != null ? _b : e.start, i = (_e2 = (_d = (_c = e.declaration) == null ? void 0 : _c.decorators) != null ? _d : e.decorators) == null ? void 0 : _e2[0];
  return i ? Math.min(M(i), t) : t;
}
function R(e) {
  var _a3, _b;
  return (_b = (_a3 = e.range) == null ? void 0 : _a3[1]) != null ? _b : e.end;
}
function Ns(e) {
  let t = new Set(e);
...
function le(e) {
  ...
  return ce = le.prototype = e != null ? e : /* @__PURE__ */ Object.create(null), new le();
}
var Fs = 10;
...
function we(e, t) {
  ...
  if (t.onEnter) {
    let s = (_a3 = t.onEnter(e)) != null ? _a3 : e;
  ...
  return e = oi(e, { onEnter(h) {
    switch (h.type) {
      case "ParenthesizedExpression": {
        ...
        return S ? void 0 : (l.extra = __spreadProps(__spreadValues({}, l.extra), { parenthesized: true }), l);
      }
      ...
      case "VariableDeclaration": {
        ...
        (l == null ? void 0 : l.init) && s[R(l)] !== ";" && (h.range = [M(h), R(l)]);
        break;
      }
...
var Pe = Gs;
var _a2;
var qs = (_a2 = String.prototype.replaceAll) != null ? _a2 : function(e, t) {
...
function Zs(e) {
  return e = typeof e == "function" ? { parse: e } : e, __spreadValues({ astFormat: "estree", hasPragma: yi, hasIgnorePragma: gi, locStart: M, locEnd: R }, e);
}
var Ie = Zs;
var Ne = "module";
var vi = "script";
...
var bi;
var ir = () => (bi != null ? bi : bi = A.extend((0, Si.default)()), bi);
function sr(e, t) {
  let i = ir(), s = [], r = i.parse(e, __spreadProps(__spreadValues({}, er), { sourceType: t === Le ? vi : t, allowImportExportEverywhere: t === Ne, onComment: s }));
  return r.comments = s, r;
}
function rr(e, t) {
  let i = Ve(t == null ? void 0 : t.filepath), s = (i ? [i] : Re).map((o) => () => sr(e, o)), r;
  try {
    r = ke(s);
  } catch ({ errors: [o] }) {
    throw tr(o);
...
function fr(e, t) {
  let i = Ve(t == null ? void 0 : t.filepath), s = (i ? [i] : Re).map((o) => () => ki(e, __spreadProps(__spreadValues({}, cr), { sourceType: o }))), r;
  try {
    r = ke(s);
  } catch ({ errors: [o] }) {
    throw lr(o);
