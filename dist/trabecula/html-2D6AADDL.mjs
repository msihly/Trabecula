...
var xe = (e, t) => (r, n, ...i) => {
  var _a5;
  return r | 1 && n == null ? void 0 : ((_a5 = t.call(n)) != null ? _a5 : n[e]).apply(n, i);
};
var _a;
var As = (_a = String.prototype.replaceAll) != null ? _a : function(e, t) {
  ...
  function i(s) {
    switch (wt(s)) {
      case je:
        return t(s.map(n));
      case Le:
        return t(__spreadProps(__spreadValues({}, s), { parts: s.parts.map(n) }));
      case Pe:
        return t(__spreadProps(__spreadValues({}, s), { breakContents: n(s.breakContents), flatContents: n(s.flatContents) }));
      case Ne: {
        let { expandedStates: a, contents: o } = s;
        return a ? (a = a.map(n), o = a[0]) : o = n(o), t(__spreadProps(__spreadValues({}, s), { contents: o, expandedStates: a }));
      }
      case ye:
      case Ae:
      case Oe:
      case Tt:
      case Ct:
        return t(__spreadProps(__spreadValues({}, s), { contents: n(s.contents) }));
      case Ye:
      case St:
      case Et:
      case vt:
...
var lr = (_a2 = class {
  ...
  hasTrailingWhitespace(t) {
    return __privateGet(this, _e).has(F(0, t, -1));
  }
  trimStart(t) {
    let r = this.getLeadingWhitespaceCount(t);
    return t.slice(r);
  ...
  split(t, r = false) {
    let n = `[${or([...__privateGet(this, _e)].join(""))}]+`, i = new RegExp(r ? `(${n})` : n, "u");
    return t.split(i);
  }
  ...
  dedentString(t) {
    let r = __privateMethod(this, _lr_instances, t_fn).call(this, t);
    return r === 0 ? t : t.split(`
`).map((n) => n.slice(r)).join(`
`);
  }
}, _e = new WeakMap(), _lr_instances = new WeakSet(), t_fn = function(t) {
...
function fn(e, t, r) {
  ...
  if (e.kind === "docType" && (t.value = w(0, e.value.toLowerCase(), /\s+/gu, " ")), e.kind === "angularControlFlowBlock" && ((_a5 = e.parameters) == null ? void 0 : _a5.children)) for (let n of t.parameters.children) Gs.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
var gn = $s;
var _a3;
var zs = (_a3 = Array.prototype.toReversed) != null ? _a3 : function() {
  return [...this].reverse();
};
...
var _n = Ys;
function js() {
  var _a5, _b, _c, _d, _e3, _f, _g, _h;
  let e = globalThis, t = (_b = (_a5 = e.Deno) == null ? void 0 : _a5.build) == null ? void 0 : _b.os;
  return typeof t == "string" ? t === "windows" : (_h = (_g = (_d = (_c = e.navigator) == null ? void 0 : _c.platform) == null ? void 0 : _d.startsWith("Win")) != null ? _g : (_f = (_e3 = e.process) == null ? void 0 : _e3.platform) == null ? void 0 : _f.startsWith("win")) != null ? _h : false;
}
var Xs = js();
function Sn(e) {
...
function vn(e, t) {
  ...
  return (_a5 = e.find(({ filenames: n }) => n == null ? void 0 : n.some((i) => i.toLowerCase() === r))) != null ? _a5 : e.find(({ extensions: n }) => n == null ? void 0 : n.some((i) => r.endsWith(i)));
}
function Zs(e, t) {
  var _a5, _b;
  if (t) return (_b = (_a5 = e.find(({ name: r }) => r.toLowerCase() === t)) != null ? _a5 : e.find(({ aliases: r }) => r == null ? void 0 : r.includes(t))) != null ? _b : e.find(({ extensions: r }) => r == null ? void 0 : r.includes(`.${t}`));
}
var ea = void 0;
function Tn(e, t) {
  if (t) {
...
function ta(e, t) {
  ...
  let r = _n(0, e.plugins).flatMap((i) => {
    var _a6;
    return (_a6 = i.languages) != null ? _a6 : [];
  });
  return (_f = (_e3 = (_d = (_c = (_b = (_a5 = Zs(r, t.language)) != null ? _a5 : vn(r, t.physicalFile)) != null ? _b : vn(r, t.file)) != null ? _c : Tn(r, t.physicalFile)) != null ? _d : Tn(r, t.file)) != null ? _e3 : ea == null ? void 0 : ea(r, t.physicalFile)) == null ? void 0 : _f.parsers[0];
}
var At = ta;
var yt = /* @__PURE__ */ Symbol.for("PRETTIER_IS_FRONT_MATTER");
function ra(e) {
  return !!(e == null ? void 0 : e[yt]);
}
var ce = ra;
var Xe = 3;
function na(e) {
...
function yn(e, t) {
  var _a5, _b;
  let r = n();
  if (r && !e.prev && ((_b = (_a5 = e.parent) == null ? void 0 : _a5.tagDefinition) == null ? void 0 : _b.ignoreFirstLf)) return e.kind === "interpolation";
  return r;
  function n() {
...
function ca(e) {
  var _a5;
  return (_a5 = e.children) == null ? void 0 : _a5.some((t) => t.kind !== "text");
}
function Mn(e) {
  if (e) switch (e) {
    case "module":
...
function ua(e, t) {
  ...
  return !s && !i ? "babel" : (_a5 = At(t, { language: s })) != null ? _a5 : Mn(i);
}
function pa(e, t) {
  var _a5;
  if (!Ot(e, t)) return;
  ...
  let { type: n, lang: i } = r;
  return (_a5 = At(t, { language: i })) != null ? _a5 : Mn(n);
}
function ha(e, t) {
  if (e.name === "style") {
...
function _r(e, t) {
  var _a5, _b;
  return (_b = (_a5 = ua(e, t)) != null ? _a5 : ha(e, t)) != null ? _b : pa(e, t);
}
function Qe(e) {
...
function Bn(e, t) {
  ...
  if (((_a5 = e.prev) == null ? void 0 : _a5.kind) === "comment") {
...
function Wn(e, t, r) {
  return __async(this, null, function* () {
    ...
    for (let [s, a] of n.split(Vn).entries()) if (s % 2 === 0) i.push(L(a));
      ...
      i.push(C(["{{", A([_, yield x(a, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: true })]), _, "}}"]));
    } catch (e2) {
      i.push("{{", L(a), "}}");
    }
    return i;
...
var si = (e, t, r) => __async(null, null, function* () {
  return K(yield e(b(r.node), { parser: "css", __isHTMLStyleAttribute: true }));
});
...
function li(e, t, r, n) {
  return __async(this, null, function* () {
    ...
    return [C(yield x(`function _(${s}) {}`, e, { parser: c ? "babel-ts" : "babel", __isVueForBindingLeft: true })), " ", a, " ", yield x(o, e, { parser: c ? "__ts_expression" : "__js_expression" })];
  });
}
function Ia(e) {
  let t = new RegExp("(.*?)\\s+(in|of)\\s+(.*)", "su"), r = /,([^,\]}]*)(?:,([^,\]}]*))?$/u, n = /^\(|\)$/gu, i = e.match(t);
  if (!i) return;
  let s = { for: i[3].trim() };
  if (!s.for) return;
...
function Ma(e, t, r, n) {
  return __async(this, null, function* () {
    var _a5;
    try {
      return yield ci(e, t, r, n);
    } catch (a) {
      if (((_a5 = a.cause) == null ? void 0 : _a5.code) !== "BABEL_PARSER_SYNTAX_ERROR") throw a;
    }
...
function qa(e, t) {
  ...
  if (n) return Rt(r, t) ? [r.rawName, "=", n] : (_a5 = Fa.find(({ test: i }) => i(e, t))) == null ? void 0 : _a5.print;
}
function Ha(e) {
  return (t, r, n, i) => __async(null, null, function* () {
    let s = yield e(t, r, n, i);
...
function Va(e, t) {
  return e.lastChild && _e2(e.lastChild) ? "" : [Ua(e, t), Mt(e, t)];
}
function fe(e, t) {
...
function V(e, t) {
  return _e2(e) ? Mt(e.parent, t) : et(e) ? Bt(e.next, t) : "";
}
function Mt(e, t) {
  if (mi(e, t)) return "";
  switch (e.kind) {
...
function ge(e) {
  var _a5;
  return ((_a5 = e.lastChild) == null ? void 0 : _a5.isTrailingSpaceSensitive) && !e.lastChild.hasTrailingSpaces && !O(Pt(e.lastChild)) && !pe(e);
}
function _e2(e) {
...
function Wa(e) {
  let t = e.trim().match(new RegExp("^prettier-ignore-attribute(?:\\s+(.+))?$", "su"));
...
function za(e, t) {
  ...
  return e.lastChild && _e2(e.lastChild) ? n += Mt(e, t).length : ge(e) && (n -= de(e.lastChild, t).length), t.originalText.slice(r, n);
}
var qt = za;
  ...
  switch (r.kind) {
    case "element":
      ...
      if (!r.isSelfClosing && Ot(r, t)) {
        let n = _r(r, t);
        return n ? (i, s) => __async(null, null, function* () {
          let a = qt(r, t), o = /^\s*$/u.test(a), c = "";
          return o || (c = yield i(fr(a), { parser: n, __embeddedInHtml: true }), o = c === ""), [U(r, t), C(rt(e, t, s)), o ? "" : v, c, o ? "" : v, Ze(r, t), V(r, t)];
        }) : void 0;
      }
      break;
    case "text":
      if (H(r.parent, t)) {
        let n = _r(r.parent, t);
        if (n) return (i) => __async(null, null, function* () {
          ...
          return [j, U(r, t), yield i(s, a), V(r, t)];
        });
      } else if (r.parent.kind === "interpolation") return (n) => __async(null, null, function* () {
        let i = { __isInHtmlInterpolation: true, __embeddedInHtml: true };
        return t.parser === "angular" ? i.parser = "__ng_interpolation" : t.parser === "vue" ? i.parser = G(e, t) ? "__vue_ts_expression" : "__vue_expression" : i.parser = "__js_expression", [A([_, yield n(r.value, i)]), r.parent.next && $(r.parent.next) ? " " : _];
      });
      break;
    case "attribute":
      return pi(e, t);
...
function it(e) {
  ...
  return nt = it.prototype = e != null ? e : /* @__PURE__ */ Object.create(null), new it();
}
var Xa = 10;
...
function Ai(e) {
  var _a5, _b;
  return !(((_a5 = e.next) == null ? void 0 : _a5.kind) === "angularControlFlowBlock" && ((_b = wi.get(e.name)) == null ? void 0 : _b.has(e.next.name)));
}
var Ja = (e) => (e == null ? void 0 : e.kind) === "angularControlFlowBlock" && (e.name === "case" || e.name === "default");
function Za(e) {
  return Ja(e) && e.endSourceSpan && e.endSourceSpan.start.offset === e.endSourceSpan.end.offset;
}
function eo(e) {
  let { previous: t } = e;
  return (t == null ? void 0 : t.kind) === "angularControlFlowBlock" && !he(t) && !Ai(t);
}
function yi(e, t, r) {
...
var Ri = class extends Di {
  ...
  getMappedPropName(e) {
    var _a5;
    return (_a5 = Ii.get(e)) != null ? _a5 : e;
  }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.` } : { error: false };
  ...
  allKnownAttributesOfElement(e) {
    ...
    return Array.from(t.keys()).map((r) => {
      var _a5;
      return (_a5 = oo.get(r)) != null ? _a5 : r;
    });
  }
  allKnownEventsOfElement(e) {
    var _a5;
    return Array.from((_a5 = this._eventSchema.get(e.toLowerCase())) != null ? _a5 : []);
  }
...
var f = class {
  constructor({ closedByChildren: e, implicitNamespacePrefix: t, contentType: r = R.PARSABLE_DATA, closedByParent: n = false, isVoid: i = false, ignoreFirstLf: s = false, preventNamespaceInheritance: a = false, canSelfClose: o = false } = {}) {
    this.closedByChildren = {}, this.closedByParent = false, e && e.length > 0 && e.forEach((c) => this.closedByChildren[c] = true), this.isVoid = i, this.closedByParent = n || i, this.implicitNamespacePrefix = t || null, this.contentType = r, this.ignoreFirstLf = s, this.preventNamespaceInheritance = a, this.canSelfClose = o != null ? o : i;
  }
  isClosedByChild(e) {
  ...
  getContentType(e) {
    var _a5;
    return typeof this.contentType == "object" ? (_a5 = e === void 0 ? void 0 : this.contentType[e]) != null ? _a5 : this.contentType.default : this.contentType;
  }
};
var Mi;
var lt;
...
var Io = class {
  constructor(e, t, r) {
    ...
    this._cursor = r.escapedString ? new Uo(e, n) : new is(e, n), this._preserveLineEndings = r.preserveLineEndings || false, this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || false, this._tokenizeBlocks = (_a5 = r.tokenizeBlocks) != null ? _a5 : true, this._tokenizeLet = (_b = r.tokenizeLet) != null ? _b : true, this._selectorlessEnabled = (_c = r.selectorlessEnabled) != null ? _c : false;
    try {
      this._cursor.init();
    } catch (i) {
      this.handleError(i);
...
`);
  ...
  _endToken(e, t) {
    ...
    let r = { type: this._currentTokenType, parts: e, sourceSpan: (t != null ? t : this._cursor).getSpan(this._currentTokenStart, this._leadingTriviaCodePoints) };
...
var Uo = class Fr extends is {
  constructor(t, r) {
    t instanceof Fr ? (super(t), this.internalState = __spreadValues({}, t.internalState)) : (super(t, r), this.internalState = this.state);
  }
  advance() {
  ...
  processEscapeSequence() {
    ...
    if (t() === 92) if (this.internalState = __spreadValues({}, this.state), this.advanceState(this.internalState), t() === 110) this.state.peek = 10;
...
`) {
  ...
  _consumeElementStartTag(t) {
    ...
    if (this._peek.type === l.TAG_OPEN_END_VOID) {
      ...
      this.canSelfClose || (E == null ? void 0 : E.canSelfClose) || Me(s) !== null || (E == null ? void 0 : E.isVoid) || this.errors.push(N.create(s, t.sourceSpan, `Only void, custom and foreign elements can be self closed "${t.parts[1]}"`));
    } else this._peek.type === l.TAG_OPEN_END && (this._advance(), o = false);
    let c = this._peek.sourceSpan.fullStart, u = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart), p = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart), d = new h(t.sourceSpan.start.moveBy(1), t.sourceSpan.end), S = new ie(s, n, i, [], o, u, p, void 0, d, (_a5 = a == null ? void 0 : a.isVoid) != null ? _a5 : false), m = this._getContainer(), g = m !== null && !!(!((r = this._getTagDefinition(m)) === null || r === void 0) && r.isClosedByChild(S.name));
  ...
  _consumeAttr(t) {
    ...
    let u = o && c && new h((_a5 = i == null ? void 0 : i.sourceSpan.start) != null ? _a5 : o.start, c, (_b = i == null ? void 0 : i.sourceSpan.fullStart) != null ? _b : o.fullStart);
  ...
  _consumeIncompleteLet(t) {
    var _a5;
    let r = (_a5 = t.parts[0]) != null ? _a5 : "", n = r ? ` "${r}"` : "";
    if (r.length > 0) {
...
function Xo(e) {
  let t = (r) => {
    var _a5, _b;
    return r.kind === "element" && ((_a5 = r.prev) == null ? void 0 : _a5.kind) === "ieConditionalStartComment" && r.prev.sourceSpan.end.offset === r.startSourceSpan.start.offset && ((_b = r.firstChild) == null ? void 0 : _b.kind) === "ieConditionalEndComment" && r.firstChild.sourceSpan.start.offset === r.startSourceSpan.end.offset;
  };
  e.walk((r) => {
...
function Jo(e) {
  let t = (r) => {
    var _a5, _b;
    return r.kind === "element" && r.attrs.length === 0 && r.children.length === 1 && r.firstChild.kind === "text" && !y.hasWhitespaceCharacter(r.children[0].value) && !r.firstChild.hasLeadingSpaces && !r.firstChild.hasTrailingSpaces && r.isLeadingSpaceSensitive && !r.hasLeadingSpaces && r.isTrailingSpaceSensitive && !r.hasTrailingSpaces && ((_a5 = r.prev) == null ? void 0 : _a5.kind) === "text" && ((_b = r.next) == null ? void 0 : _b.kind) === "text";
  };
  e.walk((r) => {
    if (r.children) for (let n = 0; n < r.children.length; n++) {
      let i = r.children[n];
...
function Jt(e) {
  return __spreadValues(__spreadValues({}, cl), e);
}
function Gr(e) {
...
var We = class We2 {
  ...
  get firstChild() {
    var _a5;
    return (_a5 = this.$children) == null ? void 0 : _a5[0];
  }
  get lastChild() {
...
oe = /* @__PURE__ */ new WeakSet(), $r = function() {
  ...
  var _a5, _b;
  return (_b = (_a5 = this.parent) == null ? void 0 : _a5.$children) != null ? _b : [];
};
var tr = We;
function ul(e, t) {
  let r = e.map(t);
...
var pl = [{ regex: new RegExp("^(?<openingTagSuffix>\\[if(?<condition>[^\\]]*)\\]>)(?<data>.*?)<!\\s*\\[endif\\]$", "su"), parse: hl }, { regex: new RegExp("^\\[if(?<condition>[^\\]]*)\\]><!$", "u"), parse: ml }, { regex: /^<!\s*\[endif\]$/u, parse: fl }];
function Es(e, t) {
...
function bs(e, t) {
  ...
  let a, o = () => a != null ? a : a = Qt(e, __spreadProps(__spreadValues({}, r), { getTagContentType: void 0 })), c = (u) => {
    var _a5;
    let { offset: p } = u.startSourceSpan.start;
    return (_a5 = o().rootNodes.find((d) => d.kind === "element" && d.startSourceSpan.start.offset === p)) != null ? _a5 : u;
  };
...
function Tl(e) {
  ...
  let t = (_a5 = e.attrs.find((r) => r.name === "lang")) == null ? void 0 : _a5.value;
  return !t || t === "html";
}
function jr(e) {
...
function bl(e, t, r, n, i, s) {
  let { offset: a } = n, o = w(0, t.slice(0, a), /[^\n]/gu, " ") + r, c = Kr(o, e, __spreadProps(__spreadValues({}, i), { shouldParseFrontMatter: false }), s);
...
function Kr(e, t, r, n = {}) {
  ...
  if (i) {
    ...
    S = __spreadProps(__spreadValues({}, i), { kind: "frontMatter", sourceSpan: new h(g, E) });
  }
...
var xl = gt(__spreadProps(__spreadValues({}, rr), { name: "mjml", shouldParseAsRawText: (e) => kl.has(e) }));
