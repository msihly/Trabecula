...
function ti({ toMessage: a2, code: t, reasonCode: e, syntaxPlugin: s }) {
  ...
  return function r(n, o) {
    ...
    return h.code = t, h.reasonCode = e, h.loc = n, h.pos = n.index, h.syntaxPlugin = s, i && (h.missingPlugin = o.missingPlugin), Ot(h, "clone", function(u = {}) {
      var _a3;
      let { line: f, column: d, index: x } = (_a3 = u.loc) != null ? _a3 : n;
...
var ai = (a2) => class extends a2 {
  ...
  isValidDirective(e) {
    var _a3;
    return e.type === "ExpressionStatement" && e.expression.type === "Literal" && typeof e.expression.value == "string" && !((_a3 = e.expression.extra) == null ? void 0 : _a3.parenthesized);
  }
  ...
  finishCallExpression(e, s) {
    ...
    return i.callee.type === "Import" ? (this.castNodeTo(i, "ImportExpression"), i.source = i.arguments[0], i.options = (_a3 = i.arguments[1]) != null ? _a3 : null, delete i.arguments, delete i.callee) : i.type === "OptionalCallExpression" ? this.castNodeTo(i, "CallExpression") : i.optional = false, i;
  }
  ...
  parseExport(e, s) {
    ...
    switch (r.type) {
      ...
      case "ExportDefaultDeclaration":
        {
          let { declaration: n } = r;
          (n == null ? void 0 : n.type) === "ClassDeclaration" && ((_a3 = n.decorators) == null ? void 0 : _a3.length) > 0 && n.start === r.start && this.resetStartLocation(r, i);
        }
        break;
    }
    return r;
...
function P(a2, t = {}) {
  var _a3, _b, _c, _d;
  return ++pe, mt.push(a2), yt.push((_a3 = t.binop) != null ? _a3 : -1), xt.push((_b = t.beforeExpr) != null ? _b : false), Pt.push((_c = t.startsExpr) != null ? _c : false), gt.push((_d = t.prefix) != null ? _d : false), dt.push(new we(a2, t)), pe;
}
function b(a2, t = {}) {
  var _a3, _b, _c, _d;
  return ++pe, ft.set(a2, pe), mt.push(a2), yt.push((_a3 = t.binop) != null ? _a3 : -1), xt.push((_b = t.beforeExpr) != null ? _b : false), Pt.push((_c = t.startsExpr) != null ? _c : false), gt.push((_d = t.prefix) != null ? _d : false), dt.push(new we("name", t)), pe;
}
...
var Mi = (a2) => class extends a2 {
  ...
  flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
    ...
    for (s && this.match(6) ? (this.expect(6), l = 9, u = true) : (this.expect(5), l = 8, u = false), h.exact = u; !this.match(l); ) {
      ...
      if (this.eat(0)) A != null && this.unexpected(A), this.eat(0) ? (C && this.unexpected(C.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, x))) : h.indexers.push(this.flowParseObjectTypeIndexer(N, x, C));
        ...
        let Pe = this.flowParseObjectTypeProperty(N, x, A, C, I, i, n != null ? n : !u);
  ...
  flowParseQualifiedTypeIdentifier(e, s) {
    e != null ? e : e = this.state.startLoc;
  ...
  finishArrowValidation(e) {
    var _a3;
    this.toAssignableList(e.params, (_a3 = e.extra) == null ? void 0 : _a3.trailingCommaLoc, false), this.scope.enter(518), super.checkParams(e, false, true), this.scope.exit();
  }
  ...
  toReferencedList(e, s) {
    ...
    for (let i = 0; i < e.length; i++) {
      let r = e[i];
      r && r.type === "TypeCastExpression" && !((_a3 = r.extra) == null ? void 0 : _a3.parenthesized) && (e.length > 1 || !s) && this.raise(g.TypeCastInPattern, r.typeAnnotation);
    }
    return e;
  }
  ...
  parseMaybeAssign(e, s) {
    ...
    if ((r == null ? void 0 : r.error) || this.match(47)) {
      ...
      let n, o = this.tryParse((l) => {
        ...
        ((_a3 = u.extra) == null ? void 0 : _a3.parenthesized) && l();
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
  ...
  jsxParseExpressionContainer(e, s) {
    ...
    if (this.match(8)) e.expression = this.jsxParseEmptyExpression();
      ...
      i.type === "SequenceExpression" && !((_a3 = i.extra) == null ? void 0 : _a3.parenthesized) && this.raise(U.UnexpectedSequenceExpression, i.expressions[1]), e.expression = i;
    }
...
var Ye = class {
  ...
  getPluginOption(t, e) {
    var _a3;
    return (_a3 = this.plugins.get(t)) == null ? void 0 : _a3[e];
  }
};
function ss(a2, t) {
    ...
    if (t.leadingNode !== null || t.trailingNode !== null) t.leadingNode !== null && ss(t.leadingNode, e), t.trailingNode !== null && Ri(t.trailingNode, e);
      ...
      if (this.input.charCodeAt(this.offsetToSourcePos(i) - 1) === 44) switch (s.type) {
        ...
        case "ImportExpression":
          $(s, [s.source, (_a3 = s.options) != null ? _a3 : null], t);
          break;
...
function is(a2, t, e, s, i, r, n, o, h, l) {
  ...
  for (let k = 0, N = r != null ? r : 1 / 0; k < N; ++k) {
...
var st = class extends Qe {
  ...
  unexpected(t, e) {
    throw this.raise(p.UnexpectedToken, t != null ? t : this.state.startLoc, { expected: e ? z(e) : null });
  }
  expectPlugin(t, e) {
    if (this.hasPlugin(t)) return true;
    throw this.raise(p.MissingPlugin, e != null ? e : this.state.startLoc, { missingPlugin: [t] });
  }
  expectOnePlugin(t) {
...
var ct = class extends ot {
  ...
  parseMaybeDefault(t, e) {
    if (t != null ? t : t = this.state.startLoc, e = e != null ? e : this.parseBindingAtom(), !this.eat(29)) return e;
  ...
  checkLVal(t, e, s = 64, i = false, r = false, n = false, o = false) {
    ...
    let f = this.isValidLVal(h, o, !(n || ((_a3 = t.extra) == null ? void 0 : _a3.parenthesized)) && e.type === "AssignmentExpression", s);
    if (f === true) return;
    if (f === false) {
...
function lt(a2) {
  var _a3;
  if ((_a3 = a2.extra) == null ? void 0 : _a3.parenthesized) return false;
  switch (a2.type) {
    case "Identifier":
      return true;
    case "MemberExpression":
...
var Ji = (a2) => class extends a2 {
  ...
  tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember }, n) {
    ...
    for (; ; ) {
      let { startLoc: l } = this.state, u = this.tsParseModifier(e.concat(s != null ? s : []), i, n.static);
      if (!u) break;
  ...
  parseNewCallee(e) {
    ...
    super.parseNewCallee(e);
    let { callee: s } = e;
    s.type === "TSInstantiationExpression" && !((_a3 = s.extra) == null ? void 0 : _a3.parenthesized) && (e.typeArguments = s.typeArguments, e.callee = s.expression);
  }
  parseExprOp(e, s, i) {
    let r;
  ...
  parseMaybeAssign(e, s) {
    ...
    let o, h = this.tryParse((l) => {
      ...
      if ((u.type !== "ArrowFunctionExpression" || ((_a3 = u.extra) == null ? void 0 : _a3.parenthesized)) && l(), (o == null ? void 0 : o.params.length) !== 0 && this.resetStartLocationFromNode(u, o), u.typeParameters = o, this.hasPlugin("jsx") && u.typeParameters.params.length === 1 && !((_b = u.typeParameters.extra) == null ? void 0 : _b.trailingComma)) {
  ...
  reportReservedArrowTypeParam(e) {
    var _a3;
    e.params.length === 1 && !e.params[0].constraint && !((_a3 = e.extra) == null ? void 0 : _a3.trailingComma) && this.getPluginOption("typescript", "disallowAmbiguousJSXLike") && this.raise(y.ReservedArrowTypeParam, e);
  }
  parseMaybeUnary(e, s) {
  ...
  fillOptionalPropertiesForTSESLint(e) {
    var _a3, _b, _c, _d, _e2, _f, _g, _h, _i2, _j, _k, _l, _m, _n, _o, _p, _q, _r2, _s2, _t2, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W;
    switch (e.type) {
      case "ExpressionStatement":
        (_a3 = e.directive) != null ? _a3 : e.directive = void 0;
        return;
      case "RestElement":
        e.value = void 0;
      case "Identifier":
      ...
      case "AssignmentPattern":
      case "ObjectPattern":
        (_b = e.decorators) != null ? _b : e.decorators = [], (_c = e.optional) != null ? _c : e.optional = false, (_d = e.typeAnnotation) != null ? _d : e.typeAnnotation = void 0;
        return;
      case "TSParameterProperty":
        (_e2 = e.accessibility) != null ? _e2 : e.accessibility = void 0, (_f = e.decorators) != null ? _f : e.decorators = [], (_g = e.override) != null ? _g : e.override = false, (_h = e.readonly) != null ? _h : e.readonly = false, (_i2 = e.static) != null ? _i2 : e.static = false;
        return;
      ...
      case "ClassMethod":
      case "ClassPrivateMethod":
        (_j = e.declare) != null ? _j : e.declare = false, (_k = e.returnType) != null ? _k : e.returnType = void 0, (_l = e.typeParameters) != null ? _l : e.typeParameters = void 0;
        return;
      case "Property":
        (_m = e.optional) != null ? _m : e.optional = false;
        return;
      case "TSMethodSignature":
      case "TSPropertySignature":
        (_n = e.optional) != null ? _n : e.optional = false;
      case "TSIndexSignature":
        (_o = e.accessibility) != null ? _o : e.accessibility = void 0, (_p = e.readonly) != null ? _p : e.readonly = false, (_q = e.static) != null ? _q : e.static = false;
        return;
      case "TSAbstractPropertyDefinition":
      case "PropertyDefinition":
      case "TSAbstractAccessorProperty":
      case "AccessorProperty":
        (_r2 = e.declare) != null ? _r2 : e.declare = false, (_s2 = e.definite) != null ? _s2 : e.definite = false, (_t2 = e.readonly) != null ? _t2 : e.readonly = false, (_u = e.typeAnnotation) != null ? _u : e.typeAnnotation = void 0;
      case "TSAbstractMethodDefinition":
      case "MethodDefinition":
        (_v = e.accessibility) != null ? _v : e.accessibility = void 0, (_w = e.decorators) != null ? _w : e.decorators = [], (_x = e.override) != null ? _x : e.override = false, (_y = e.optional) != null ? _y : e.optional = false;
        return;
      case "ClassExpression":
        (_z = e.id) != null ? _z : e.id = null;
      case "ClassDeclaration":
        (_A = e.abstract) != null ? _A : e.abstract = false, (_B = e.declare) != null ? _B : e.declare = false, (_C = e.decorators) != null ? _C : e.decorators = [], (_D = e.implements) != null ? _D : e.implements = [], (_E = e.superTypeArguments) != null ? _E : e.superTypeArguments = void 0, (_F = e.typeParameters) != null ? _F : e.typeParameters = void 0;
        return;
      case "TSTypeAliasDeclaration":
      case "VariableDeclaration":
        (_G = e.declare) != null ? _G : e.declare = false;
        return;
      case "VariableDeclarator":
        (_H = e.definite) != null ? _H : e.definite = false;
        return;
      case "TSEnumDeclaration":
        (_I = e.const) != null ? _I : e.const = false, (_J = e.declare) != null ? _J : e.declare = false;
        return;
      case "TSEnumMember":
        (_K = e.computed) != null ? _K : e.computed = false;
        return;
      case "TSImportType":
        (_L = e.qualifier) != null ? _L : e.qualifier = null, (_M = e.options) != null ? _M : e.options = null, (_N = e.typeArguments) != null ? _N : e.typeArguments = null;
        return;
      case "TSInterfaceDeclaration":
        (_O = e.declare) != null ? _O : e.declare = false, (_P = e.extends) != null ? _P : e.extends = [];
        return;
      case "TSMappedType":
        (_Q = e.optional) != null ? _Q : e.optional = false, (_R = e.readonly) != null ? _R : e.readonly = void 0;
        return;
      case "TSModuleDeclaration":
        (_S = e.declare) != null ? _S : e.declare = false, (_T = e.global) != null ? _T : e.global = e.kind === "global";
        return;
      case "TSTypeParameter":
        (_U = e.const) != null ? _U : e.const = false, (_V = e.in) != null ? _V : e.in = false, (_W = e.out) != null ? _W : e.out = false;
        return;
    }
  }
...
var Qi = (a2) => class extends a2 {
  ...
  parseExpressionStatement(e, s) {
    var _a3;
    if (s.type !== "Placeholder" || ((_a3 = s.extra) == null ? void 0 : _a3.parenthesized)) return super.parseExpressionStatement(e, s);
    if (this.match(14)) {
      let r = e;
  ...
  maybeParseExportDefaultSpecifier(e, s) {
    var _a3;
    return ((_a3 = e.specifiers) == null ? void 0 : _a3.length) ? true : super.maybeParseExportDefaultSpecifier(e, s);
  }
  checkExport(e) {
    let { specifiers: s } = e;
...
var pt = class extends ct {
  ...
  parseHackPipeBody() {
    ...
    return Qs.has(e.type) && !((_a3 = e.extra) == null ? void 0 : _a3.parenthesized) && this.raise(p.PipeUnparenthesizedBody, t, { type: e.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, t), e;
  }
  ...
  parseAsyncArrowFromCallExpression(t, e) {
    var _a3;
    return this.resetPreviousNodeTrailingComments(e), this.expect(19), this.parseArrowExpression(t, e.arguments, true, (_a3 = e.extra) == null ? void 0 : _a3.trailingCommaLoc), e.innerComments && X(t, e.innerComments), e.callee.trailingComments && X(t, e.callee.trailingComments), t;
  }
  parseNoCallExpr() {
    let t = this.state.startLoc;
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
  ...
  checkGetterSetterParams(t) {
    ...
    s.length !== e && this.raise(t.kind === "get" ? p.BadGetterArity : p.BadSetterArity, t), t.kind === "set" && ((_a3 = s[s.length - 1]) == null ? void 0 : _a3.type) === "RestElement" && this.raise(p.BadSetterRestParameter, t);
  }
...
var ut = class extends pt {
  ...
  maybeTakeDecorators(t, e, s) {
    var _a3;
    return t && (((_a3 = e.decorators) == null ? void 0 : _a3.length) ? (typeof this.getPluginOption("decorators", "decoratorsBeforeExport") != "boolean" && this.raise(p.DecoratorsBeforeAfterExport, e.decorators[0]), e.decorators.unshift(...t)) : e.decorators = t, this.resetStartLocationFromNode(e, t[0]), s && this.resetStartLocationFromNode(s, e)), e;
  }
  canHaveLeadingDecorator() {
  ...
  parseClassStaticBlock(t, e) {
    ...
    let i = e.body = [];
    this.parseBlockOrModuleBlockBody(i, void 0, false, 8), this.prodParam.exit(), this.scope.exit(), this.state.labels = s, t.body.push(this.finishNode(e, "StaticBlock")), ((_a3 = e.decorators) == null ? void 0 : _a3.length) && this.raise(p.DecoratorStaticBlock, e);
  }
  ...
  parseExport(t, e) {
    ...
    if (l || u || f) {
      let d = t;
      if (this.checkExport(d, true, false, !!d.source), ((_a3 = d.declaration) == null ? void 0 : _a3.type) === "ClassDeclaration") this.maybeTakeDecorators(e, d.declaration, d);
  ...
  maybeParseExportNamespaceSpecifier(t) {
    var _a3;
    if (this.isContextual(93)) {
      (_a3 = t.specifiers) != null ? _a3 : t.specifiers = [];
    ...
    if (e) {
      if (s) {
        if (this.checkDuplicateExports(t, "default"), this.hasPlugin("exportDefaultFrom")) {
          let r = t.declaration;
          r.type === "Identifier" && r.name === "from" && r.end - r.start === 4 && !((_a3 = r.extra) == null ? void 0 : _a3.parenthesized) && this.raise(p.ExportDefaultFromAsIdentifier, r);
        }
  ...
  checkImportReflection(t) {
    ...
    t.phase === "source" ? s !== "ImportDefaultSpecifier" && this.raise(p.SourcePhaseImportRequiresDefault, e[0].loc.start) : t.phase === "defer" ? s !== "ImportNamespaceSpecifier" && this.raise(p.DeferImportRequiresNamespace, e[0].loc.start) : t.module && (s !== "ImportDefaultSpecifier" && this.raise(p.ImportReflectionNotBinding, e[0].loc.start), ((_a3 = t.assertions) == null ? void 0 : _a3.length) > 0 && this.raise(p.ImportReflectionHasAssertion, e[0].loc.start));
  }
  ...
  parseImportSourceAndAttributes(t) {
    var _a3;
    return (_a3 = t.specifiers) != null ? _a3 : t.specifiers = [], t.source = this.parseImportSource(), this.maybeParseImportAttributes(t), this.checkImportReflection(t), this.checkJSONModuleImport(t), this.semicolon(), this.sawUnambiguousESM = true, this.finishNode(t, "ImportDeclaration");
  }
  parseImportSource() {
...
var ee = (a2, t) => (e, s, ...i) => {
  var _a3;
  return e | 1 && s == null ? void 0 : ((_a3 = t.call(s)) != null ? _a3 : s[a2]).apply(s, i);
};
var _a;
var ur = (_a = Array.prototype.findLast) != null ? _a : function(a2) {
...
function M(a2) {
  ...
  let t = (_b = (_a3 = a2.range) == null ? void 0 : _a3[0]) != null ? _b : a2.start, e = (_e2 = (_d = (_c = a2.declaration) == null ? void 0 : _c.decorators) != null ? _d : a2.decorators) == null ? void 0 : _e2[0];
  return e ? Math.min(M(e), t) : t;
}
function L(a2) {
  var _a3, _b;
  return (_b = (_a3 = a2.range) == null ? void 0 : _a3[1]) != null ? _b : a2.end;
}
function yr(a2) {
  let t = new Set(a2);
...
function ye(a2) {
  ...
  return me = ye.prototype = a2 != null ? a2 : /* @__PURE__ */ Object.create(null), new ye();
}
var wr = 10;
...
function Le(a2, t) {
  ...
  if (t.onEnter) {
    let s = (_a3 = t.onEnter(a2)) != null ? _a3 : a2;
  ...
  return a2 = Es(a2, { onEnter(h) {
    switch (h.type) {
      case "ParenthesizedExpression": {
        ...
        return f ? void 0 : (l.extra = __spreadProps(__spreadValues({}, l.extra), { parenthesized: true }), l);
      }
      ...
      case "TopicReference":
        a2.extra = __spreadProps(__spreadValues({}, a2.extra), { __isUsingHackPipeline: true });
        break;
      case "TSUnionType":
...
var Me = kr;
var _a2;
var vr = (_a2 = String.prototype.replaceAll) != null ? _a2 : function(a2, t) {
...
function _r(a2) {
  return a2 = typeof a2 == "function" ? { parse: a2 } : a2, __spreadValues({ astFormat: "estree", hasPragma: Rs, hasIgnorePragma: Us, locStart: M, locEnd: L }, a2);
}
var H = _r;
var Oe = "module";
var Nt = "commonjs";
...
var _ = (a2, t = Vr) => __spreadProps(__spreadValues({}, t), { plugins: [...t.plugins, ...a2] });
var zr = /@(?:no)?flow\b/u;
function qr(a2, t) {
...
function Kr({ isExpression: a2 = false, optionsCombinations: t }) {
  return (e, s = {}) => {
    ...
    let r = t, n = (_a3 = s.__babelSourceType) != null ? _a3 : _s(i);
    n && n !== Oe && (r = r.map((u) => __spreadValues(__spreadProps(__spreadValues({}, u), { sourceType: n }), n === Nt ? { allowReturnOutsideFunction: void 0, allowNewTargetOutsideFunction: void 0 } : void 0)));
    let o = /%[A-Z]/u.test(e);
...
var ra = __spreadValues(__spreadValues({}, kt), Lt);
export {
  Ks as default,
  ra as parsers
};
