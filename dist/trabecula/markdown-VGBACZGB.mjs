...
var mr = x((hv, Hu) => {
  ...
  function ep(e, r) {
    var t = {}, n, i;
    r || (r = {});
    for (i in Ru) n = r[i], t[i] = n != null ? n : Ru[i];
...
var Me = (e, r) => (t, n, ...i) => {
  var _a4;
  return t | 1 && n == null ? void 0 : ((_a4 = r.call(n)) != null ? _a4 : n[e]).apply(n, i);
};
function yl(e) {
...
var U = wl;
var _a;
var kl = (_a = String.prototype.replaceAll) != null ? _a : function(e, r) {
  ...
  function i(u) {
    switch (W(u)) {
      case j:
        return r(u.map(n));
      case J:
        return r(__spreadProps(__spreadValues({}, u), { parts: u.parts.map(n) }));
      case Q:
        return r(__spreadProps(__spreadValues({}, u), { breakContents: n(u.breakContents), flatContents: n(u.flatContents) }));
      case X: {
        let { expandedStates: a, contents: o } = u;
        return a ? (a = a.map(n), o = a[0]) : o = n(o), r(__spreadProps(__spreadValues({}, u), { contents: o, expandedStates: a }));
      }
      case re:
      case ee:
      case pe:
      case me:
      case he:
        return r(__spreadProps(__spreadValues({}, u), { contents: n(u.contents) }));
      case V:
      case be:
      case De:
      case de:
...
function ni(e, r, t) {
  ...
  return D(), __spreadProps(__spreadValues({}, e), { value: i, length: u, queue: n });
  function s(p) {
...
function ii(e, r, t) {
  if (!r) return e;
  if (r.type === "root") return __spreadProps(__spreadValues({}, e), { root: e });
...
var H = /* @__PURE__ */ Symbol("MODE_BREAK");
var ue = /* @__PURE__ */ Symbol("MODE_FLAT");
var bt = /* @__PURE__ */ Symbol("DOC_FILL_PRINTED_LENGTH");
function Pr(e, r, t, n, i, u) {
  ...
  for (; t >= 0; ) {
    ...
    switch (D) {
      ...
      case j:
      case J: {
        let m = D === j ? f : f.parts, p = (_a4 = f[bt]) != null ? _a4 : 0;
...
`, i) : A;
      ...
      case X:
        ...
        break;
      case J: {
        let b = n - u, d = (_a4 = A[bt]) != null ? _a4 : 0, { parts: y } = A, w = y.length - d;
        if (w === 0) break;
        ...
        let N = y[d + 2], O = { indent: E, mode: v, doc: __spreadProps(__spreadValues({}, A), { [bt]: d + 2 }) }, le = Pr({ indent: E, mode: ue, doc: [C, k, N] }, [], b, l.length > 0, t, true);
...
var bi = Re(Tr(), 1);
var _a2;
var ef = (_a2 = Array.prototype.toReversed) != null ? _a2 : function() {
  return [...this].reverse();
};
...
var Di = rf;
function tf() {
  var _a4, _b, _c, _d, _e3, _f2, _g, _h;
  let e = globalThis, r = (_b = (_a4 = e.Deno) == null ? void 0 : _a4.build) == null ? void 0 : _b.os;
  return typeof r == "string" ? r === "windows" : (_h = (_g = (_d = (_c = e.navigator) == null ? void 0 : _c.platform) == null ? void 0 : _d.startsWith("Win")) != null ? _g : (_f2 = (_e3 = e.process) == null ? void 0 : _e3.platform) == null ? void 0 : _f2.startsWith("win")) != null ? _h : false;
}
var nf = tf();
function pi(e) {
...
function mi(e, r) {
  ...
  return (_a4 = e.find(({ filenames: n }) => n == null ? void 0 : n.some((i) => i.toLowerCase() === t))) != null ? _a4 : e.find(({ extensions: n }) => n == null ? void 0 : n.some((i) => t.endsWith(i)));
}
function of(e, r) {
  var _a4, _b;
  if (r) return (_b = (_a4 = e.find(({ name: t }) => t.toLowerCase() === r)) != null ? _a4 : e.find(({ aliases: t }) => t == null ? void 0 : t.includes(r))) != null ? _b : e.find(({ extensions: t }) => t == null ? void 0 : t.includes(`.${r}`));
}
var sf = void 0;
function Fi(e, r) {
  if (r) {
...
function cf(e, r) {
  ...
  let t = Di(0, e.plugins).flatMap((i) => {
    var _a5;
    return (_a5 = i.languages) != null ? _a5 : [];
  });
  return (_f2 = (_e3 = (_d = (_c = (_b = (_a4 = of(t, r.language)) != null ? _a4 : mi(t, r.physicalFile)) != null ? _b : mi(t, r.file)) != null ? _c : Fi(t, r.physicalFile)) != null ? _d : Fi(t, r.file)) != null ? _e3 : sf == null ? void 0 : sf(t, r.physicalFile)) == null ? void 0 : _f2.parsers[0];
}
var wt = cf;
...
var Lr = (e) => {
  var _a4;
  return ((_a4 = _e(e).content.trimStart().match(Ci)) == null ? void 0 : _a4.index) === 0;
};
var vi = (e) => {
  var _a4;
  return ((_a4 = _e(e).content.trimStart().match(Ei)) == null ? void 0 : _a4.index) === 0;
};
var Ai = (e) => {
...
function ze(e, r) {
  let t = r.originalText.slice(e.position.start.offset, e.position.end.offset), { numberText: n, leadingSpaces: i } = t.match(new RegExp("^\\s*(?<numberText>\\d+)(\\.|\\))(?<leadingSpaces>\\s*)", "u")).groups;
...
function df(e, r) {
  ...
  switch (t.type) {
    case "code": {
      ...
      if (!n) return;
      let i;
      return n === "angular-ts" ? i = wt(r, { language: "typescript" }) : n === "angular-html" ? i = "angular" : i = wt(r, { language: n }), i ? (u) => __async(null, null, function* () {
        let a = { parser: i };
        n === "ts" || n === "typescript" ? a.filepath = "dummy.ts" : n === "tsx" && (a.filepath = "dummy.tsx");
        let o = yield u(Ur(t, r.originalText), a), s = r.__inJsTemplate ? "~" : "`", l = s.repeat(Math.max(3, Ir(t.value, s) + 1));
...
function Dr(e) {
  ...
  return fr = Dr.prototype = e != null ? e : /* @__PURE__ */ Object.create(null), new Dr();
}
var Ff = 10;
...
function Si(e, r, t) {
  let { node: n } = e, i = [], u = e.map(() => e.map(({ index: f }) => {
    ...
    return i[f] = Math.max((_a4 = i[f]) != null ? _a4 : 3, m), { text: D, width: m };
...
var _e2, __t_instances, r_fn, _a3;
var _t = (_a3 = class {
  constructor(r) {
...
function Of(e, r) {
  return ye(e, (t) => {
    ...
    return Bf.test(i) ? t : __spreadProps(__spreadValues({}, t), { value: i });
  });
}
function qf(e, r, t) {
  return ye(e, (n) => {
    ...
    return a ? __spreadProps(__spreadValues({}, n), { children: i }) : n;
  });
}
function Nf(e) {
...
function Wi(e) {
  ...
  return (r == null ? void 0 : r.type) === "sentence" && ((_a4 = U(0, r.children, -1)) == null ? void 0 : _a4.type) === "word" && !U(0, r.children, -1).hasTrailingPunctuation || (t == null ? void 0 : t.type) === "sentence" && ((_b = t.children[0]) == null ? void 0 : _b.type) === "word" && !t.children[0].hasLeadingPunctuation;
}
function Yf(e, r, t) {
  let { node: n } = e;
  if (zf(e)) {
...
`, " "), u = oi(i, "`"), a = "`".repeat(u), o = i.startsWith("`") || i.endsWith("`") || /^[\n ]/u.test(i) && /[\n ]$/u.test(i) && /[^\n ]/u.test(i) ? " " : "";
    ...
    case "html": {
      let { parent: i, isLast: u } = e, a = i.type === "root" && u ? n.value.trimEnd() : n.value, o = new RegExp("^<!--.*-->$", "su").test(a);
...
var uF = function() {
  ...
  function r(t, n) {
    ...
    if (i) return t(i.raw)(__spreadProps(__spreadValues({}, i), { type: "frontMatter" }));
  }
  r.onlyAtStart = true;
};
var ol = uF;
function aF() {
  return (e) => ye(e, (r, t, [n]) => r.type !== "html" || tl.test(r.value) || Rr.has(n.type) ? r : __spreadProps(__spreadValues({}, r), { type: "jsx" }));
}
var sl = aF;
var oF = function() {
...
function ml({ isMDX: e }) {
  return (r) => {
    let t = (0, dl.default)().use(hl.default, __spreadValues({ commonmark: true }, e && { blocks: [rl] })).use(Dl.default).use(ol).use(pl.default).use(e ? al : fl).use(cl).use(e ? sl : fl).use(ll);
...
var cF = __spreadProps(__spreadValues({}, Fl), { parse: ml({ isMDX: false }) });
var lF = __spreadProps(__spreadValues({}, Fl), { parse: ml({ isMDX: true }) });
var fF = { mdast: Hi };
export {
  gl as default,
  Ki as languages,
